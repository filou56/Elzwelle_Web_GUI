...
function Ea(a){for(;a.h.h;)try{var b=a.i(a.h);if(b)return a.h.C=!1,{value:b.value,done:!1}}catch(c){a.h.i=void 0,ta(a.h,c)}a.h.C=!1;if(a.h.j){b=a.h.j;a.h.j=null;if(b.zb)throw b.vb;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
...
b.race=function(g){return new b(function(h,k){for(var m=q(g),p=m.next();!p.done;p=m.next())d(p.value).Ia(h,k)})};
b.all=function(g){var h=q(g),k=h.next();return k.done?d([]):new b(function(m,p){function v(E){return function(F){x[E]=F;u--;0==u&&m(x)}}
var x=[],u=0;do x.push(void 0),u++,d(k.value).Ia(v(x.length-1),p),k=h.next();while(!k.done)})};
return b});
...
function Ma(){}
function Na(a){a.eb=void 0;a.getInstance=function(){return a.eb?a.eb:a.eb=new a}}
...
;function ab(a,b){if(Error.captureStackTrace)Error.captureStackTrace(this,ab);else{var c=Error().stack;c&&(this.stack=c)}a&&(this.message=String(a));void 0!==b&&(this.Pb=b)}
...
r(I,wd);if(Xc){var zd={};Object.defineProperties(I,(zd[Symbol.hasInstance]=Yc(Object[Symbol.hasInstance]),zd))};function Ad(){var a=this;this.promise=new Promise(function(b,c){a.resolve=b;a.reject=c})}
;function Bd(a){this.i=!1;var b=a.program;a=a.globalName;var c=new Ad;this.j=c.promise;this.l=q((0,y[a].a)(b,function(d,e){Promise.resolve().then(function(){c.resolve({Ob:d,xc:e})})},!0)).next().value;
this.wc=c.promise.then(function(){})}
Bd.prototype.snapshot=function(a){if(this.i)throw Error("Already disposed");return this.j.then(function(b){var c=b.Ob;return new Promise(function(d){c(function(e){d(e)},[a.qb,
a.yc])})})};
...
return a}
var Pd={Pc:"allow-forms",Qc:"allow-modals",Rc:"allow-orientation-lock",Sc:"allow-pointer-lock",Tc:"allow-popups",Uc:"allow-popups-to-escape-sandbox",Vc:"allow-presentation",Wc:"allow-same-origin",Xc:"allow-scripts",Yc:"allow-top-navigation",Zc:"allow-top-navigation-by-user-activation"},Rd=cb(function(){return Qd()});
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var m,p;a();return{reset:a,update:c,digest:d,Sb:function(){for(var v=d(),x="",u=0;u<v.length;u++)x+="0123456789ABCDEF".charAt(Math.floor(v[u]/16))+"0123456789ABCDEF".charAt(v[u]%16);return x}}}
...
l=he.prototype;l.isEnabled=function(){if(!y.navigator.cookieEnabled)return!1;if(!this.isEmpty())return!0;this.set("TESTCOOKIESENABLED","1",{Pa:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
l.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Po;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.Pa}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.h.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
l.Za=function(){return ie(this).keys};
...
var qg=qd;function hg(a){ab.call(this,a)}
Za(hg,ab);hg.prototype.name="cancel";function L(a){J.call(this);this.u=1;this.l=[];this.m=0;this.i=[];this.j={};this.A=!!a}
...
l.ta=function(a){var b=this.i[a];if(b){var c=this.j[b];0!=this.m?(this.l.push(a),this.i[a+1]=Ma):(c&&jb(c,a),delete this.i[a],delete this.i[a+1],delete this.i[a+2])}return!!b};
...
Za(xg,ug);xg.prototype.set=function(a,b,c){if(b=wg(b)){if(c){if(c<Date.now()){xg.prototype.remove.call(this,a);return}b.expiration=c}b.creation=Date.now()}xg.aa.set.call(this,a,b)};
...
;function zg(){}
Za(zg,yg);zg.prototype[Symbol.iterator]=function(){return Hf(this.Z(!0)).j()};
zg.prototype.clear=function(){var a=Array.from(this);a=q(a);for(var b=a.next();!b.done;b=a.next())this.remove(b.value)};function Ag(a){this.h=a}
Za(Ag,zg);l=Ag.prototype;l.isAvailable=function(){if(!this.h)return!1;try{return this.h.setItem("__sak","1"),this.h.removeItem("__sak"),!0}catch(a){return!1}};
...
Za(Hg,zg);Hg.prototype.set=function(a,b){this.i.set(this.h+a,b)};
...
r(Ig,I);Ig.prototype.getKey=function(){return Zc(this,1)};
Ig.prototype.getValue=function(){return Zc(this,2===bd(this,Jg)?2:-1)};
Ig.prototype.setValue=function(a){return ad(this,2,Jg,a)};
var Jg=[2,3,4,5,6];function Kg(a){I.call(this,a)}
r(Kg,I);function Lg(a){I.call(this,a)}
r(Lg,I);function Mg(a){I.call(this,a)}
r(Mg,I);function Ng(a){I.call(this,a,-1,Og)}
r(Ng,I);Ng.prototype.getPlayerType=function(){return Zc(this,36)};
Ng.prototype.setHomeGroupInfo=function(a){return H(this,81,a)};
var Og=[9,66,24,32,86,100,101];function Pg(a){I.call(this,a,-1,Qg)}
r(Pg,I);var Qg=[15,26,28];function Rg(a){I.call(this,a)}
r(Rg,I);Rg.prototype.setToken=function(a){return D(this,2,a)};function Sg(a){I.call(this,a,-1,Tg)}
r(Sg,I);Sg.prototype.setSafetyMode=function(a){return D(this,5,a)};
var Tg=[12];function Ug(a){I.call(this,a,-1,Vg)}
r(Ug,I);var Vg=[12];function Wg(a){I.call(this,a,-1,Xg)}
r(Wg,I);function Yg(a){I.call(this,a)}
r(Yg,I);Yg.prototype.getKey=function(){return jd(this,1)};
Yg.prototype.getValue=function(){return jd(this,2)};
Yg.prototype.setValue=function(a){return D(this,2,a)};
var Xg=[4,5];function Zg(a){I.call(this,a)}
r(Zg,I);function $g(a){I.call(this,a)}
r($g,I);var ah=[2,3];function bh(a){I.call(this,a)}
r(bh,I);bh.prototype.getMessage=function(){return jd(this,1)};function ch(a){I.call(this,a)}
r(ch,I);function dh(a){I.call(this,a)}
r(dh,I);function eh(a){I.call(this,a,-1,fh)}
r(eh,I);var fh=[10,17];function gh(a){I.call(this,a)}
r(gh,I);function hh(a){I.call(this,a)}
r(hh,I);function ih(a){I.call(this,a)}
r(ih,I);var jh={Ah:0,lh:1,rh:2,sh:4,xh:8,th:16,uh:32,zh:64,yh:128,nh:256,ph:512,wh:1024,oh:2048,qh:4096,mh:8192,vh:16384};function kh(a){I.call(this,a)}
r(kh,I);function lh(a,b){H(a,1,b)}
kh.prototype.X=function(a){D(this,2,a)};
function mh(a){I.call(this,a)}
r(mh,I);function nh(a,b){H(a,1,b)}
;function oh(a){I.call(this,a,-1,ph)}
r(oh,I);oh.prototype.X=function(a){D(this,1,a)};
function qh(a,b){H(a,2,b)}
var ph=[3];function rh(a){I.call(this,a)}
r(rh,I);rh.prototype.X=function(a){D(this,1,a)};function sh(a){I.call(this,a)}
...
r(uh,I);function vh(a){I.call(this,a)}
...
Gh.prototype.getPlaylistId=function(){return Zc(this,2===bd(this,Hh)?2:-1)};
...
r(Lh,I);var Mh;Mh=new function(a,b){this.h=a;this.fieldName=b;this.isRepeated=0;this.i=yd}(406606992,{Ho:0},Lh);function Nh(){Lh.apply(this,arguments)}
...
adNotify:!0,adNotifyFilled:!0,tvhtml5LaunchUrlComponentChanged:!0,bedrockResourceConsumptionSnapshot:!0,deviceStartupMetrics:!0,mdxSignIn:!0,tvhtml5KeyboardLogging:!0,tvhtml5StartupSoundEvent:!0,tvhtml5LiveChatStatus:!0,tvhtml5DeviceStorageStatus:!0,tvhtml5LocalStorage:!0,directSignInEvent:!0,finalPayload:!0,tvhtml5SearchCompleted:!0,tvhtml5KeyboardPerformance:!0,adNotifyFailure:!0,latencyActionSpan:!0,tvhtml5AccountDialogOpened:!0,tvhtml5ApiTest:!0};var hi=0,ii=vc?"webkit":uc?"moz":sc?"ms":rc?"o":"";z("ytDomDomGetNextId",A("ytDomDomGetNextId")||function(){return++hi},void 0);var ji=[];function ki(a){ji.forEach(function(b){return b(a)})}
...
Fi.prototype.pause=function(){var a=A("yt.scheduler.instance.pause");a&&a()};var bf=Gi();var Hi={};
function Ii(a){var b=void 0===a?{}:a;a=void 0===b.fc?!1:b.fc;b=void 0===b.Ub?!0:b.Ub;if(null==A("_lact",window)){var c=parseInt(B("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;z("_lact",c,window);z("_fact",c,window);-1==c&&Ji();ui(document,"keydown",Ji);ui(document,"keyup",Ji);ui(document,"mousedown",Ji);ui(document,"mouseup",Ji);a?ui(window,"touchmove",function(){ej("touchmove",200)},{passive:!0}):(ui(window,"resize",function(){ej("resize",200)}),b&&ui(window,"scroll",function(){ej("scroll",200)}));
new zi(function(){ej("mouse",100)});
ui(document,"touchstart",Ji,{passive:!0});ui(document,"touchend",Ji,{passive:!0})}}
function ej(a,b){Hi[a]||(Hi[a]=!0,bf.N(function(){Ji();Hi[a]=!1},b))}
function Ji(){null==A("_lact",window)&&Ii();var a=Date.now();z("_lact",a,window);-1==A("_fact",window)&&z("_fact",a,window);(a=A("ytglobal.ytUtilActivityCallback_"))&&a()}
...
;var jj=/^[\w.]*$/,kj={q:!0,search_query:!0};function lj(a,b){b=a.split(b);for(var c={},d=0,e=b.length;d<e;d++){var f=b[d].split("=");if(1==f.length&&f[0]||2==f.length)try{var g=mj(f[0]||""),h=mj(f[1]||"");g in c?Array.isArray(c[g])?kb(c[g],h):c[g]=[c[g],h]:c[g]=h}catch(v){var k=v,m=f[0],p=String(lj);k.args=[{key:m,value:f[1],query:a,method:nj==p?"unchanged":p}];kj.hasOwnProperty(m)||ni(k)}}return c}
...
function nk(a,b){if("log_event"===a.endpoint){var c=ik(a),d=new Map;d.set(c,[a.payload]);b&&(Yj=new b);return new $f(function(e){Yj&&Yj.isReady()?ok(d,e,{bypassNetworkless:!0},!0):e()})}}
function pk(a,b){if("log_event"===a.endpoint){var c=ik(a,!0),d=new Map;d.set(c,[td(a.payload)]);b&&(Yj=new b);return new $f(function(e){Yj&&Yj.isReady()?qk(d,e,{bypassNetworkless:!0},!0):e()})}}
function ik(a,b){var c="";if(a.va)c="visitorOnlyApprovedKey";else if(a.cttAuthInfo){if(void 0===b?0:b){b=a.cttAuthInfo.token;c=a.cttAuthInfo;var d=new Gh;c.videoId?d.setVideoId(c.videoId):c.playlistId&&ad(d,2,Hh,c.playlistId);gk[b]=d}else b=a.cttAuthInfo,c={},b.videoId?c.videoId=b.videoId:b.playlistId&&(c.playlistId=b.playlistId),fk[a.cttAuthInfo.token]=c;c=a.cttAuthInfo.token}return c}
function lk(a,b,c){a=void 0===a?{}:a;c=void 0===c?!1:c;new $f(function(d){c?(yi(bk.i),yi(bk.h),bk.h=0):(yi(ak.i),yi(ak.h),ak.h=0);if(Yj&&Yj.isReady())if(void 0!==b)if(c){var e=new Map,f=ek.get(b)||[];e.set(b,f);qk(e,d,a);ek.delete(b)}else e=new Map,f=dk.get(b)||[],e.set(b,f),ok(e,d,a),dk.delete(b);else c?(qk(ek,d,a),ek.clear()):(ok(dk,d,a),dk.clear());else mk(c),d()})}
...
g||b()},d));
ck=!1}}
function qk(a,b,c,d){var e=Yj;c=void 0===c?{}:c;var f=Math.round(Q()),g=a.size;a=q(a);for(var h=a.next();!h.done;h=a.next()){var k=q(h.value);h=k.next().value;var m=k=k.next().value;k=new Ih;var p=yk(e.config_||sk());H(k,1,p);m=zk(m);for(p=0;p<m.length;p++)id(k,3,Dh,m[p]);(m=gk[h])&&Ak(k,h,m);delete gk[h];h="visitorOnlyApprovedKey"===h;Bk(k,f,h);vk(c);k=td(k);h=xk(c,h,function(){g--;g||b()},function(){g--;
g||b()},d);
...
function xk(a,b,c,d,e){return{retry:!0,onSuccess:c,onError:d,Bb:a,va:b,Eo:!!e,headers:{},postBodyFormat:"",postBody:""}}
...
function Bk(a,b,c){D(a,2,b);if(!c&&(b=B("EVENT_ID",void 0))){c=Ck();var d=new Fh;D(d,1,b);D(d,2,c);H(a,5,d)}}
...
function Ak(a,b,c){if(Zc(c,1===bd(c,Hh)?1:-1))var d=1;else if(c.getPlaylistId())d=2;else return;H(a,4,c);a=fd(a,Ug,1)||new Ug;c=fd(a,Sg,3)||new Sg;var e=new Rg;e.setToken(b);D(e,1,d);id(c,12,Rg,e);H(a,3,c)}
function zk(a){for(var b=[],c=0;c<a.length;c++)try{var d=b,e=d.push;var f=String(a[c]),g=Dh;if(null==f||""==f)var h=new g;else{var k=JSON.parse(f);Array.isArray(k)||qd(Error("Expected to deserialize an Array but got "+Oa(k)+": "+k));sd=k;var m=new g(k);sd=null;h=m}e.call(d,h)}catch(p){mi(new P("Transport failed to deserialize "+String(a[c])))}return b}
;var Dk=y.ytLoggingGelSequenceIdObj_||{};z("ytLoggingGelSequenceIdObj_",Dk,void 0);
function Ek(a,b,c,d){d=void 0===d?{}:d;if(M("lr_drop_other_and_business_payloads")){if(gi[a]||fi[a])return}else if(M("lr_drop_other_payloads")&&gi[a])return;var e={},f=Math.round(d.timestamp||Q());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=fj();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};M("log_sequence_info_on_gel_web")&&d.W&&(a=e.context,b=d.W,b={index:Fk(b),groupKey:b},a.sequence=b,d.ub&&delete Dk[d.W]);(d.oc?nk:hk)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,
va:d.va},c)}
...
;function Jk(a,b,c,d,e){je.set(""+a,b,{Pa:c,path:"/",domain:void 0===d?"youtube.com":d,secure:void 0===e?!1:e})}
function Kk(a){return je.get(""+a,void 0)}
function Lk(){if(!je.isEnabled())return!1;if(!je.isEmpty())return!0;je.set("TESTCOOKIESENABLED","1",{Pa:60});if("1"!==je.get("TESTCOOKIESENABLED"))return!1;je.remove("TESTCOOKIESENABLED");return!0}
...
function yk(a){var b=new Ug,c=new Ng;D(c,1,a.yb);D(c,2,a.xb);D(c,16,a.Wb);D(c,17,a.innertubeContextClientVersion);if(a.bb){var d=a.bb,e=new Kg;d.coldConfigData&&D(e,1,d.coldConfigData);d.appInstallData&&D(e,6,d.appInstallData);d.coldHashData&&D(e,3,d.coldHashData);d.hotHashData&&D(e,5,d.hotHashData);H(c,62,e)}(d=y.devicePixelRatio)&&1!=d&&D(c,65,d);d=di();""!==d&&D(c,54,d);d=ei();if(0<d.length){e=new Pg;for(var f=0;f<d.length;f++){var g=new Ig;D(g,1,d[f].key);g.setValue(d[f].value);id(e,15,Ig,g)}H(b,
5,e)}$k(a,c);al(a,c);bl(c);cl(a,c);dl(c);B("DELEGATED_SESSION_ID")&&!M("pageid_as_header_web")&&(a=new Sg,D(a,3,B("DELEGATED_SESSION_ID")));a=q(Object.entries(pj(B("DEVICE",""))));for(d=a.next();!d.done;d=a.next())e=q(d.value),d=e.next().value,e=e.next().value,"cbrand"===d?D(c,12,e):"cmodel"===d?D(c,13,e):"cbr"===d?D(c,87,e):"cbrver"===d?D(c,88,e):"cos"===d?D(c,18,e):"cosver"===d?D(c,19,e):"cplatform"===d&&D(c,42,e);H(b,1,c);return b}
function $k(a,b,c){a=a.cb;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=fd(b,Lg,96)||new Lg;var d=Ik();null!==d&&D(c,3,d);H(b,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=Hk())}
function al(a,b,c){a=a.cb;if(("WEB_REMIX"===a||76===a)&&!M("music_web_display_mode_killswitch"))if(b){var d;c=null!=(d=fd(b,Mg,70))?d:new Mg;d=Ik();null!==d&&D(c,10,d);H(b,70,c)}else if(c){var e;c.client.Ab=null!=(e=c.client.Ab)?e:{};c.client.Ab.webDisplayMode=Hk()}}
function bl(a,b){var c;if(M("web_log_memory_total_kbytes")&&(null==(c=y.navigator)?0:c.deviceMemory)){var d;c=null==(d=y.navigator)?void 0:d.deviceMemory;a?D(a,95,1E6*c):b&&(b.client.memoryTotalKbytes=""+1E6*c)}}
function cl(a,b,c){if(a.appInstallData)if(b){var d;c=null!=(d=fd(b,Kg,62))?d:new Kg;D(c,6,a.appInstallData);H(b,62,c)}else c&&(c.client.configInfo=c.client.configInfo||{},c.client.configInfo.appInstallData=a.appInstallData)}
function dl(a,b){var c=Xk();c&&(a?D(a,61,Tk[c]):b&&(b.client.connectionType=c));M("web_log_effective_connection_type")&&(c=Yk())&&(a?D(a,94,Uk[c]):b&&(b.client.effectiveConnectionType=c))}
function el(a,b,c){c=void 0===c?{}:c;var d={};M("enable_web_eom_visitor_data")&&B("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":B("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||B("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Co||B("AUTHORIZATION"))||(a?b="Bearer "+A("gapi.auth.getToken")().Bo:b=ne([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=B("SESSION_INDEX",0),M("pageid_as_header_web")&&(d["X-Goog-PageId"]=B("DELEGATED_SESSION_ID")));return d}
...
;function gl(a){var b=new Bg;(b=b.isAvailable()?a?new Hg(b,a):b:null)||(a=new Cg(a||"UserDataSharedStore"),b=a.isAvailable()?a:null);this.h=(a=b)?new xg(a):null;this.i=document.domain||window.location.hostname}
gl.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.h)try{this.h.set(a,b,Date.now()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Rf(b))}catch(f){return}else e=escape(b);Jk(a,e,c,this.i)};
...
a);
if("AbortError"===e.name)return new Jl("UNKNOWN_ABORT",a,e.message);e.args=[Object.assign(Object.assign({},a),{name:"IdbError",Cb:e.name})];e.level="WARNING";return e}
...
Sl.all=function(a){return new Sl(new Rl(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={ma:0};f.ma<a.length;f={ma:f.ma},++f.ma)Tl(Sl.resolve(a[f.ma]).then(function(g){return function(h){d[g.ma]=h;e--;0===e&&b(d)}}(f)),function(g){c(g)})}))};
...
function bm(a,b,c,d){var e,f,g,h,k,m,p,v,x,u,E,F;return w(function(K){switch(K.h){case 1:var O={mode:"readonly",O:!1,tag:"IDB_TRANSACTION_TAG_UNKNOWN"};"string"===typeof c?O.mode=c:Object.assign(O,c);e=O;a.transactionCount++;f=e.O?3:1;g=0;case 2:if(h){K.s(3);break}g++;k=Math.round(Q());ua(K,4);m=a.h.transaction(b,e.mode);O=new fm(m);O=gm(O,d);return t(K,O,6);case 6:return p=K.i,v=Math.round(Q()),hm(a,k,v,g,void 0,b.join(),e),K.return(p);case 4:x=xa(K);u=Math.round(Q());E=Nl(x,a.h.name,b.join(),a.h.version);
if((F=E instanceof Jl&&!E.h)||g>=f)hm(a,k,u,g,E,b.join(),e),h=E;K.s(2);break;case 3:return K.return(Promise.reject(h))}})}
...
var g=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var h=c.blocked,k=c.blocking,m=c.Ac,p=c.upgrade,v=c.closed,x;g.addEventListener("upgradeneeded",function(u){try{if(null===u.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");u.dataLoss&&"none"!==u.dataLoss&&yl("IDB_DATA_CORRUPTED",{reason:u.dataLossMessage||"unknown reason",dbName:Cl(a)});var E=f(),F=new fm(g.transaction);
...
function rm(a,b){b=void 0===b?{}:b;var c,d,e,f;return w(function(g){if(1==g.h)return ua(g,2),c=self.indexedDB.deleteDatabase(a),d=b,(e=d.blocked)&&c.addEventListener("blocked",function(){e()}),t(g,Yl(c),4);
...
tm.prototype.open=function(){function a(){var f,g,h,k,m,p,v,x,u,E;return w(function(F){switch(F.h){case 1:return h=null!==(f=Error().stack)&&void 0!==f?f:"",ua(F,2),t(F,c.j(c.name,c.options.version,e),4);case 4:k=F.i;for(var K=c.options,O=[],N=q(Object.keys(K.xa)),R=N.next();!R.done;R=N.next()){R=R.value;var W=K.xa[R],ob=void 0===W.jc?Number.MAX_VALUE:W.jc;!(k.h.version>=W.Wa)||k.h.version>=ob||k.h.objectStoreNames.contains(R)||O.push(R)}m=O;if(0===m.length){F.s(5);break}p=Object.keys(c.options.xa);
v=k.objectStoreNames();if(c.m<ci("ytidb_reopen_db_retries",0))return c.m++,k.close(),xl(new Jl("DB_REOPENED_BY_MISSING_OBJECT_STORES",{dbName:c.name,expectedObjectStores:p,foundObjectStores:v})),F.return(a());if(!(c.o<ci("ytidb_remake_db_retries",1))){F.s(6);break}c.o++;if(!M("ytidb_remake_db_enable_backoff_delay")){F.s(7);break}return t(F,sm(c.i),8);case 8:c.i*=2;case 7:return t(F,c.delete(),9);case 9:return xl(new Jl("DB_DELETED_BY_MISSING_OBJECT_STORES",{dbName:c.name,expectedObjectStores:p,foundObjectStores:v})),
F.return(a());case 6:throw new Kl(v,p);case 5:return F.return(k);case 2:x=xa(F);if(x instanceof DOMException?"VersionError"!==x.name:"DOMError"in self&&x instanceof DOMError?"VersionError"!==x.name:!(x instanceof Object&&"message"in x)||"An attempt was made to open a database using a lower version than the existing version."!==x.message){F.s(10);break}return t(F,c.j(c.name,void 0,Object.assign(Object.assign({},e),{upgrade:void 0})),11);case 11:u=F.i;E=u.h.version;if(void 0!==c.options.version&&E>
c.options.version+1)throw u.close(),c.l=!1,um(c,E);return F.return(u);case 10:throw b(),x instanceof Error&&!M("ytidb_async_stack_killswitch")&&(x.stack=x.stack+"\n"+h.substring(h.indexOf("\n")+1)),Nl(x,c.name,"",null!==(g=c.options.version)&&void 0!==g?g:-1);}})}
function b(){c.h===d&&(c.h=void 0)}
var c=this;if(!this.l)throw um(this);if(this.h)return this.h;var d,e={blocking:function(f){f.close()},
closed:b,Ac:b,upgrade:this.options.upgrade};return this.h=d=a()};var wm=new tm("YtIdbMeta",{xa:{databases:{Wa:1}},upgrade:function(a,b){b(1)&&cm(a,"databases",{keyPath:"actualName"})}});
...
ua(d,2);c={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0};return t(d,xm(c,Em),4);case 4:return t(d,ym("yt-idb-test-do-not-use",Em),5);case 5:return d.return(!0);case 2:return xa(d),d.return(!1)}})}
...
function Nm(a,b,c,d){var e,f,g,h,k,m;return w(function(p){switch(p.h){case 1:return f=null!==(e=Error().stack)&&void 0!==e?e:"",t(p,Im(),2);case 2:g=p.i;if(!g)throw h=Ol("openDbImpl",a,b),M("ytidb_async_stack_killswitch")||(h.stack=h.stack+"\n"+f.substring(f.indexOf("\n")+1)),xl(h),h;Bl(a);k=c?{actualName:a,publicName:a,userIdentifier:void 0}:Mm(a);ua(p,3);return t(p,xm(k,g),5);case 5:return t(p,qm(k.actualName,b,d),6);case 6:return p.return(p.i);case 3:return m=xa(p),ua(p,7),t(p,ym(k.actualName,
...
this.qa=function(){};
this.now=Date.now;this.wa=!1;this.Jb=null!==(b=a.Jb)&&void 0!==b?b:100;this.Hb=null!==(c=a.Hb)&&void 0!==c?c:1;this.Fb=null!==(d=a.Fb)&&void 0!==d?d:2592E6;this.Db=null!==(e=a.Db)&&void 0!==e?e:12E4;this.Gb=null!==(f=a.Gb)&&void 0!==f?f:5E3;this.v=null!==(g=a.v)&&void 0!==g?g:void 0;this.Ka=!!a.Ka;this.Ja=null!==(h=a.Ja)&&void 0!==h?h:.1;this.Ra=null!==(k=a.Ra)&&void 0!==k?k:10;a.handleError&&(this.handleError=a.handleError);a.qa&&(this.qa=a.qa);a.wa&&(this.wa=a.wa);this.D=a.D;this.U=a.U;this.K=a.K;
this.J=a.J;this.da=a.da;this.ib=a.ib;this.hb=a.hb;this.v&&(!this.D||this.D("networkless_logging"))&&Vm(this)}
function Vm(a){a.v&&!a.wa&&(a.h=!0,a.Ka&&Math.random()<=a.Ja&&a.K.Qb(a.v),Wm(a),a.J.H()&&a.Aa(),a.J.V(a.ib,a.Aa.bind(a)),a.J.V(a.hb,a.nb.bind(a)))}
...
this.da(d.url,d.options);this.K.set(d,this.v).then(function(g){d.id=g;e&&c.K.oa(d.id,c.v)}).catch(function(g){Ym(c,g)})}else this.da(a,b)};
l.Aa=function(){var a=this;if(!this.v)throw Ol("throttleSend");this.i||(this.i=this.U.N(function(){var b;return w(function(c){if(1==c.h)return t(c,a.K.wb("NEW",a.v),2);if(3!=c.h)return b=c.i,b?t(c,Xm(a,b),3):(a.nb(),c.return());a.i&&(a.i=0,a.Aa());c.h=0})},this.Jb))};
l.nb=function(){this.U.T(this.i);this.i=0};
function Xm(a,b){var c,d;return w(function(e){switch(e.h){case 1:if(!a.v)throw c=Ol("immediateSend"),c;if(void 0===b.id){e.s(2);break}return t(e,a.K.ac(b.id,a.v),3);case 3:(d=e.i)?b=d:a.qa(Error("The request cannot be found in the database."));case 2:if(Zm(a,b,a.Fb)){e.s(4);break}a.qa(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.s(5);break}return t(e,a.K.oa(b.id,a.v),5);case 5:return e.return();case 4:b.skipRetry||(b=$m(a,b));if(!b){e.s(0);break}if(!b.skipRetry||
...
b.options.onError=function(e,f){var g;return w(function(h){switch(h.h){case 1:g=an(f);if(!(a.D&&a.D("nwl_consider_error_code")&&g||a.D&&!a.D("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.Ra)){h.s(2);break}if(!a.J.ea){h.s(3);break}return t(h,a.J.ea(),3);case 3:if(a.J.H()){h.s(2);break}c(e,f);if(!a.D||!a.D("nwl_consider_error_code")||void 0===(null===b||void 0===b?void 0:b.id)){h.s(6);break}return t(h,a.K.jb(b.id,a.v,!1),6);case 6:return h.return();case 2:if(a.D&&a.D("nwl_consider_error_code")&&
!g&&a.potentialEsfErrorCounter>a.Ra)return h.return();a.potentialEsfErrorCounter++;if(void 0===(null===b||void 0===b?void 0:b.id)){h.s(8);break}return b.sendCount<a.Hb?t(h,a.K.jb(b.id,a.v),12):t(h,a.K.oa(b.id,a.v),8);case 12:a.U.N(function(){a.J.H()&&a.Aa()},a.Gb);
case 8:c(e,f),h.h=0}})};
var d=b.options.onSuccess?b.options.onSuccess:function(){};
b.options.onSuccess=function(e,f){return w(function(g){if(1==g.h)return void 0===(null===b||void 0===b?void 0:b.id)?g.s(2):t(g,a.K.oa(b.id,a.v),2);a.J.ca&&a.D&&a.D("vss_network_hint")&&a.J.ca(!0);d(e,f);g.h=0})};
return b}
function Zm(a,b,c){b=b.timestamp;return a.now()-b>=c?!1:!0}
function Wm(a){if(!a.v)throw Ol("retryQueuedRequests");a.K.wb("QUEUED",a.v).then(function(b){b&&!Zm(a,b,a.Db)?a.U.N(function(){return w(function(c){if(1==c.h)return void 0===b.id?c.s(2):t(c,a.K.jb(b.id,a.v),2);Wm(a);c.h=0})}):a.J.H()&&a.Aa()})}
function Ym(a,b){a.Lb&&!a.J.H()?a.Lb(b):a.handleError(b)}
...
cn.prototype.toString=function(){return this.topic};var dn=A("ytPubsub2Pubsub2Instance")||new L;L.prototype.subscribe=L.prototype.subscribe;L.prototype.unsubscribeByKey=L.prototype.ta;L.prototype.publish=L.prototype.ja;L.prototype.clear=L.prototype.clear;z("ytPubsub2Pubsub2Instance",dn,void 0);var en=A("ytPubsub2Pubsub2SubscribedKeys")||{};z("ytPubsub2Pubsub2SubscribedKeys",en,void 0);var fn=A("ytPubsub2Pubsub2TopicToKeys")||{};z("ytPubsub2Pubsub2TopicToKeys",fn,void 0);var gn=A("ytPubsub2Pubsub2IsAsync")||{};z("ytPubsub2Pubsub2IsAsync",gn,void 0);
...
;var Dn={},En=rn("ServiceWorkerLogsDatabase",{xa:(Dn.SWHealthLog={Wa:1},Dn),kb:!0,upgrade:function(a,b){b(1)&&cm(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).h.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
...
window.navigator.sendBeacon(a,"")){var p=!0;break b}}catch(v){}p=!1}b=p?!0:!1}else b=!1;b||Ln(a)}}
...
;var Sn=ci("network_polling_interval",3E4);function Tn(){Ve.call(this);var a=this;this.M=0;this.S=this.m=!1;this.j=this.ab();M("use_shared_nsm")?(this.i=af(),M("use_shared_nsm_and_keep_yt_online_updated")&&(this.i.V("networkstatus-online",function(){a.j=!0}),this.i.V("networkstatus-offline",function(){a.j=!1}))):(Un(this),Vn(this))}
r(Tn,Ve);function mo(){if(!Tn.h){var a=A("yt.networkStatusManager.instance")||new Tn;z("yt.networkStatusManager.instance",a,void 0);Tn.h=a}return Tn.h}
l=Tn.prototype;l.H=function(){var a;return M("use_shared_nsm")&&this.i?null===(a=this.i)||void 0===a?void 0:a.H():this.j};
l.ca=function(a){var b;M("use_shared_nsm")&&this.i?null===(b=this.i)||void 0===b?void 0:b.i=a:a!==this.j&&(this.j=a)};
l.cc=function(a){!M("use_shared_nsm")&&(this.m=!0,void 0===a?0:a)&&(this.M||Lo(this))};
...
function Vn(a){window.addEventListener("online",function(){return w(function(b){if(1==b.h)return t(b,a.ea(),2);a.S&&Rn();b.h=0})})}
function Un(a){window.addEventListener("offline",function(){return w(function(b){return t(b,a.ea(),0)})})}
function Lo(a){a.M=Bi(function(){return w(function(b){if(1==b.h)return a.j?a.ab()||!a.m?b.s(3):t(b,a.ea(),3):t(b,a.ea(),3);Lo(a);b.h=0})},Sn)}
...
Tn.prototype.sendNetworkCheckRequest=Tn.prototype.ea;Tn.prototype.listen=Tn.prototype.V;Tn.prototype.enableErrorFlushing=Tn.prototype.Tb;Tn.prototype.getWindowStatus=Tn.prototype.ab;Tn.prototype.monitorNetworkStatusChange=Tn.prototype.cc;Tn.prototype.networkStatusHint=Tn.prototype.ca;Tn.prototype.isNetworkAvailable=Tn.prototype.H;Tn.getInstance=mo;function Mo(a){a=void 0===a?{}:a;Ve.call(this);var b=this;this.j=this.M=0;this.m="ytnetworkstatus-offline";this.u="ytnetworkstatus-online";M("use_shared_nsm")&&(this.m="networkstatus-offline",this.u="networkstatus-online");this.i=mo();var c=A("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.i);c&&c(a.tb);a.Oa&&!M("use_shared_nsm")&&(c=A("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.i))&&c();if(c=A("yt.networkStatusManager.instance.listen").bind(this.i))a.Ta?
(this.Ta=a.Ta,c(this.u,function(){No(b,"publicytnetworkstatus-online");M("use_shared_nsm")&&a.Oa&&Rn()}),c(this.m,function(){No(b,"publicytnetworkstatus-offline")})):(c(this.u,function(){We(b,"publicytnetworkstatus-online");
M("use_shared_nsm")&&a.Oa&&Rn()}),c(this.m,function(){We(b,"publicytnetworkstatus-offline")}))}
...
function No(a,b){a.Ta?a.j?(bf.T(a.M),a.M=bf.N(function(){a.A!==b&&(We(a,b),a.A=b,a.j=Q())},a.Ta-(Q()-a.j))):(We(a,b),a.A=b,a.j=Q()):We(a,b)}
;var Oo;function Po(){Um.call(this,{K:{Qb:Bn,oa:An,wb:xn,ac:yn,jb:zn,set:vn},J:Qo(),handleError:mi,qa:ni,da:Ro,now:Q,Lb:Qn,U:Gi(),ib:"publicytnetworkstatus-online",hb:"publicytnetworkstatus-offline",Ka:!0,Ja:.1,Ra:ci("potential_esf_error_limit",10),D:M,wa:!(zl()&&So())});this.j=new Ad;M("networkless_immediately_drop_all_requests")&&Cn();Tm("LogsDatabaseV2")}
r(Po,Um);function To(){var a=A("yt.networklessRequestController.instance");a||(a=new Po,z("yt.networklessRequestController.instance",a,void 0),M("networkless_logging")&&Im().then(function(b){a.v=b;Vm(a);a.j.resolve();a.Ka&&Math.random()<=a.Ja&&a.v&&Gn(a.v);M("networkless_immediately_drop_sw_health_store")&&Uo(a)}));
return a}
...
function Qo(){Oo||(Oo=new Mo({Oa:!0,tb:!0}));return Oo}
...
function cp(){if(M("use_new_nwl"))return Qo();Zo||(Zo=new Mo({Oa:!0,tb:!0}));return Zo}
...
function wk(a,b,c,d){function e(E){E=void 0===E?!1:E;var F;if(d.retry&&"www.youtube-nocookie.com"!=h&&(E||M("skip_ls_gel_retry")||"application/json"!==g.headers["Content-Type"]||(F=jl(b,c,m,k)),F)){var K=g.onSuccess,O=g.onFetchSuccess;g.onSuccess=function(N,R){kl(F);K(N,R)};
c.onFetchSuccess=function(N,R){kl(F);O(N,R)}}try{E&&d.retry&&!d.Bb.bypassNetworkless?(g.method="POST",d.Bb.writeThenSend?M("use_new_nwl_wts")?To().writeThenSend(u,g):gp(u,g):M("use_new_nwl_saw")?To().sendAndWrite(u,g):kp(u,g)):(g.method="POST",g.postParams||(g.postParams={}),Dj(u,g))}catch(N){if("InvalidAccessError"==N.name)F&&(kl(F),F=0),ni(Error("An extension is blocking network request."));
else throw N;}F&&Bi(function(){ll(a)},5E3)}
...
Qa:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var rp={ha:[],ga:[{ka:qp,weight:500}]};function qp(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
...
;var Bp=y.ytLoggingGelSequenceIdObj_||{};z("ytLoggingGelSequenceIdObj_",Bp,void 0);function Cp(a,b,c){c=void 0===c?{}:c;var d=Math.round(c.timestamp||Q());D(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=fj();d=new Ch;D(d,1,c.timestamp||!isFinite(e)?-1:e);if(M("log_sequence_info_on_gel_web")&&c.W){e=c.W;var f=Fk(e),g=new Bh;D(g,2,f);D(g,1,e);H(d,3,g);c.ub&&delete Bp[c.W]}H(a,33,d);(c.oc?pk:kk)({endpoint:"log_event",payload:a,cttAuthInfo:c.cttAuthInfo,va:c.va},b)}
...
k.push("File name: "+a.fileName);k.push("Stacktrace: "+a.stack);window.console.log(k.join("\n"),a)}if(!(5<=Mp)){var m=Pp,p=te(a),v=p.message||"Unknown Error",x=p.name||"UnknownError",u=p.stack||a.i||"Not available";if(u.startsWith(x+": "+v)){var E=u.split("\n");E.shift();u=E.join("\n")}var F=p.lineNumber||"Not available",K=p.fileName||"Not available",O=u,N=0;if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var R=0;R<a.args.length&&!(N=yp(a.args[R],"params."+R,g,N),500<=N);R++);else if(a.hasOwnProperty("params")&&
a.params){var W=a.params;if("object"===typeof a.params)for(var ob in W){if(W[ob]){var ba="params."+ob,da=Ap(W[ob]);g[ba]=da;N+=ba.length+da.length;if(500<N)break}}else g.params=Ap(W)}if(m.length)for(var ha=0;ha<m.length&&!(N=yp(m[ha],"params.context."+ha,g,N),500<=N);ha++);navigator.vendor&&!g.hasOwnProperty("vendor")&&(g["device.vendor"]=navigator.vendor);var G={message:v,name:x,lineNumber:F,fileName:K,stack:O,params:g,sampleWeight:1},Ba=Number(a.columnNumber);isNaN(Ba)||(G.lineNumber=G.lineNumber+
":"+Ba);if("IGNORED"===a.level)var va=0;else a:{for(var Wn=up(),Xn=q(Wn.ha),Ki=Xn.next();!Ki.done;Ki=Xn.next()){var Yn=Ki.value;if(G.message&&G.message.match(Yn.Jo)){va=Yn.weight;break a}}for(var Zn=q(Wn.ga),Li=Zn.next();!Li.done;Li=Zn.next()){var $n=Li.value;if($n.ka(G)){va=$n.weight;break a}}va=1}G.sampleWeight=va;for(var ao=q(pp),Mi=ao.next();!Mi.done;Mi=ao.next()){var Ni=Mi.value;if(Ni.Qa[G.name])for(var bo=q(Ni.Qa[G.name]),Oi=bo.next();!Oi.done;Oi=bo.next()){var co=Oi.value,Sf=G.message.match(co.regexp);
if(Sf){G.params["params.error.original"]=Sf[0];for(var Pi=co.groups,eo={},cd=0;cd<Pi.length;cd++)eo[Pi[cd]]=Sf[cd+1],G.params["params.error."+Pi[cd]]=Sf[cd+1];G.message=Ni.gb(eo);break}}}G.params||(G.params={});var fo=up();G.params["params.errorServiceSignature"]="msg="+fo.ha.length+"&cb="+fo.ga.length;G.params["params.serviceWorker"]="false";y.document&&y.document.querySelectorAll&&(G.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Db("sample").constructor!==
Bb&&(G.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(G);if(0!==G.sampleWeight&&!Lp.has(G.message)){if("ERROR"===h){vp.ja("handleError",G);if(M("record_app_crashed_web")&&0===Op&&1===G.sampleWeight)if(Op++,M("errors_via_jspb")){var Qi=new gh;D(Qi,1,1);if(!M("report_client_error_with_app_crash_ks")){var go=new bh;D(go,1,G.message);var ho=new ch;H(ho,3,go);var io=new dh;H(io,5,ho);var jo=new eh;H(jo,9,io);H(Qi,4,jo)}var ko=new Dh;hd(ko,20,Eh,Qi);Dp(ko,void 0)}else{var lo=
{appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(lo.systemHealth={crashData:{clientError:{logMessage:{message:G.message}}}});wl("appCrashed",lo)}Np++}else"WARNING"===h&&vp.ja("handleWarning",G);if(M("kevlar_gel_error_routing"))a:{var ae=h;if(M("errors_via_jspb")){if(Tp())var no=void 0;else{var dd=new Zg;D(dd,1,G.stack);G.fileName&&D(dd,4,G.fileName);var tb=G.lineNumber&&G.lineNumber.split?G.lineNumber.split(":"):[];0!==tb.length&&(1!==tb.length||isNaN(Number(tb[0]))?
2!==tb.length||isNaN(Number(tb[0]))||isNaN(Number(tb[1]))||(D(dd,2,Number(tb[0])),D(dd,3,Number(tb[1]))):D(dd,2,Number(tb[0])));var oc=new bh;D(oc,1,G.message);D(oc,3,G.name);D(oc,6,G.sampleWeight);"ERROR"===ae?D(oc,2,2):"WARNING"===ae?D(oc,2,1):D(oc,2,0);var Ri=new $g;D(Ri,1,!0);hd(Ri,3,ah,dd);var Ob=new Wg;D(Ob,3,window.location.href);for(var oo=B("FEXP_EXPERIMENTS",[]),Si=0;Si<oo.length;Si++){var Ft=oo[Si];Wc(Ob);$c(Ob,5).push(Ft)}var Ti=B("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0);if(!ai()&&
Ti)for(var po=q(Object.keys(Ti)),pc=po.next();!pc.done;pc=po.next()){var qo=pc.value,Ui=new Yg;D(Ui,1,qo);Ui.setValue(String(Ti[qo]));id(Ob,4,Yg,Ui)}var Vi=G.params;if(Vi){var ro=q(Object.keys(Vi));for(pc=ro.next();!pc.done;pc=ro.next()){var so=pc.value,Wi=new Yg;D(Wi,1,"client."+so);Wi.setValue(String(Vi[so]));id(Ob,4,Yg,Wi)}}var to=$h("SERVER_NAME"),uo=$h("SERVER_VERSION");if(to&&uo){var Xi=new Yg;D(Xi,1,"server.name");Xi.setValue(to);id(Ob,4,Yg,Xi);var Yi=new Yg;D(Yi,1,"server.version");Yi.setValue(uo);
id(Ob,4,Yg,Yi)}var Tf=new ch;H(Tf,1,Ob);H(Tf,2,Ri);H(Tf,3,oc);no=Tf}var vo=no;if(!vo)break a;var wo=new Dh;hd(wo,163,Eh,vo);Dp(wo,void 0)}else{if(Tp())var xo=void 0;else{var be={stackTrace:G.stack};G.fileName&&(be.filename=G.fileName);var ub=G.lineNumber&&G.lineNumber.split?G.lineNumber.split(":"):[];0!==ub.length&&(1!==ub.length||isNaN(Number(ub[0]))?2!==ub.length||isNaN(Number(ub[0]))||isNaN(Number(ub[1]))||(be.lineNumber=Number(ub[0]),be.columnNumber=Number(ub[1])):be.lineNumber=Number(ub[0]));
var Zi={level:"ERROR_LEVEL_UNKNOWN",message:G.message,errorClassName:G.name,sampleWeight:G.sampleWeight};"ERROR"===ae?Zi.level="ERROR_LEVEL_ERROR":"WARNING"===ae&&(Zi.level="ERROR_LEVEL_WARNNING");var Gt={isObfuscated:!0,browserStackInfo:be},ed={pageUrl:window.location.href,kvPairs:[]};B("FEXP_EXPERIMENTS")&&(ed.experimentIds=B("FEXP_EXPERIMENTS"));var $i=B("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0);if(!ai()&&$i)for(var yo=q(Object.keys($i)),qc=yo.next();!qc.done;qc=yo.next()){var zo=qc.value;
ed.kvPairs.push({key:zo,value:String($i[zo])})}var aj=G.params;if(aj){var Ao=q(Object.keys(aj));for(qc=Ao.next();!qc.done;qc=Ao.next()){var Bo=qc.value;ed.kvPairs.push({key:"client."+Bo,value:String(aj[Bo])})}}var Co=$h("SERVER_NAME"),Do=$h("SERVER_VERSION");Co&&Do&&(ed.kvPairs.push({key:"server.name",value:Co}),ed.kvPairs.push({key:"server.version",value:Do}));xo={errorMetadata:ed,stackTrace:Gt,logMessage:Zi}}var Eo=xo;if(!Eo)break a;wl("clientError",Eo)}("ERROR"===ae||M("errors_flush_gel_always_killswitch"))&&
lk()}if(!M("suppress_error_204_logging")){var ce=G.params||{},Pb={urlParams:{a:"logerror",t:"jserror",type:G.name,msg:G.message.substr(0,250),line:G.lineNumber,level:h,"client.name":ce.name},postParams:{url:B("PAGE_NAME",window.location.href),file:G.fileName},method:"POST"};ce.version&&(Pb["client.version"]=ce.version);if(Pb.postParams){G.stack&&(Pb.postParams.stack=G.stack);for(var Fo=q(Object.keys(ce)),bj=Fo.next();!bj.done;bj=Fo.next()){var Go=bj.value;Pb.postParams["client."+Go]=ce[Go]}var cj=
B("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0);if(cj)for(var Ho=q(Object.keys(cj)),dj=Ho.next();!dj.done;dj=Ho.next()){var Io=dj.value;Pb.postParams[Io]=cj[Io]}var Jo=B("SERVER_NAME",void 0),Ko=B("SERVER_VERSION",void 0);Jo&&Ko&&(Pb.postParams["server.name"]=Jo,Pb.postParams["server.version"]=Ko)}Dj(B("ECATCHER_REPORT_HOST","")+"/error_204",Pb)}try{Lp.add(G.message)}catch(ev){}Mp++}}}}
...
function Wp(a){a=q(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.Mo("ABORTED")}
...
return a.join("")}
;var $p=y.ytLoggingDocDocumentNonce_;$p||($p=Zp(),Ya("ytLoggingDocDocumentNonce_",$p));var aq=$p;var bq={wg:0,qd:1,yd:2,Yj:3,yg:4,Yn:5,Ok:6,pm:7,Rl:8,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS"};function cq(a){this.h=a}
...
fo:55759,ho:64031,oo:93044,po:93045,qo:34388,ro:17657,so:17655,to:39579,uo:39578,vo:77448,wo:8196,xo:11357,yo:69877,zo:8197,Ao:82039};function qq(){var a=vb(rq),b;return gg(new $f(function(c,d){a.onSuccess=function(e){xj(e)?c(new sq(e)):d(new tq("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
b=Dj("//web.archive.org/web/20220308204523/https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof hg&&b.abort();
return eg(c)})}
...
;function yq(a){ab.call(this,a.message||a.description||a.name);this.isMissing=a instanceof zq;this.isTimeout=a instanceof tq&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof hg}
...
function Dq(a,b){xi(function(){gg(qq().then(Bq,function(c){return Cq(b,c)}),Ma)},a)}
function Eq(){try{var a=A("yt.ads.biscotti.getId_");return a?a():hj()}catch(b){return eg(b)}}
...
Math.round(window.devicePixelRatio||1);p.screenDensityFloat=window.devicePixelRatio||1;p.utcOffsetMinutes=-Math.floor((new Date).getTimezoneOffset());var v=void 0===v?!1:v;Nk.getInstance();var x="USER_INTERFACE_THEME_LIGHT";Qk(165)?x="USER_INTERFACE_THEME_DARK":Qk(174)?x="USER_INTERFACE_THEME_LIGHT":!M("kevlar_legacy_browsers")&&window.matchMedia&&window.matchMedia("(prefers-color-scheme)").matches&&window.matchMedia("(prefers-color-scheme: dark)").matches&&(x="USER_INTERFACE_THEME_DARK");v=v?x:Sq()||
x;p.userInterfaceTheme=v;if(!g){if(v=Xk())p.connectionType=v;M("web_log_effective_connection_type")&&(v=Yk())&&(h.client.effectiveConnectionType=v)}M("web_log_memory_total_kbytes")&&(null===(k=y.navigator)||void 0===k?0:k.deviceMemory)&&(k=null===(m=y.navigator)||void 0===m?void 0:m.deviceMemory,h.client.memoryTotalKbytes=""+1E6*k);m=qj(y.location.href);!M("web_populate_internal_geo_killswitch")&&m.internalcountrycode&&(p.internalGeo=m.internalcountrycode);"MWEB"===p.clientName||"WEB"===p.clientName?
(p.mainAppWebInfo={graftUrl:y.location.href},M("kevlar_woffle")&&Gk.h&&(p.mainAppWebInfo.pwaInstallabilityStatus=Gk.h.h?"PWA_INSTALLABILITY_STATUS_CAN_BE_INSTALLED":"PWA_INSTALLABILITY_STATUS_UNKNOWN"),p.mainAppWebInfo.webDisplayMode=Hk(),p.mainAppWebInfo.isWebNativeShareAvailable=navigator&&void 0!==navigator.share):"TVHTML5"===p.clientName&&(!M("web_lr_app_quality_killswitch")&&(m=B("LIVING_ROOM_APP_QUALITY"))&&(p.tvAppInfo=Object.assign(p.tvAppInfo||{},{appQuality:m})),m=B("LIVING_ROOM_CERTIFICATION_SCOPE"))&&
(p.tvAppInfo=Object.assign(p.tvAppInfo||{},{certificationScope:m}));if(!M("web_populate_time_zone_itc_killswitch")){b:{if("undefined"!==typeof Intl)try{var u=(new Intl.DateTimeFormat).resolvedOptions().timeZone;break b}catch(ha){}u=void 0}u&&(p.timeZone=u)}(u=di())?p.experimentsToken=u:delete p.experimentsToken;u=ei();Tq.h||(Tq.h=new Tq);p=Tq.h.h;m=[];k=0;for(var E in p)m[k++]=p[E];h.request=Object.assign(Object.assign({},h.request),{internalExperimentFlags:u,consistencyTokenJars:m});!M("web_prequest_context_killswitch")&&
(E=B("INNERTUBE_CONTEXT_PREQUEST_CONTEXT"))&&(h.request.externalPrequestContext=E);u=Nk.getInstance();E=Qk(58);u=u.get("gsml","");h.user=Object.assign({},h.user);E&&(h.user.enableSafetyMode=E);u&&(h.user.lockedSafetyMode=!0);M("warm_op_csn_cleanup")?f&&(g=jq())&&(h.clientScreenNonce=g):!g&&(g=jq())&&(h.clientScreenNonce=g);e&&(h.clickTracking={clickTrackingParams:e});if(e=A("yt.mdx.remote.remoteClient_"))h.remoteClient=e;M("web_enable_client_location_service")&&Wq.getInstance().setLocationOnInnerTubeContext(h);
try{var F=tj(void 0),K=F.bid;delete F.bid;h.adSignalsInfo={params:[],bid:K};for(var O=q(Object.entries(F)),N=O.next();!N.done;N=O.next()){var R=q(N.value),W=R.next().value,ob=R.next().value;F=W;K=ob;null===(d=h.adSignalsInfo.params)||void 0===d?void 0:d.push({key:F,value:""+K})}}catch(ha){Rp(ha)}d=h}else Rp(Error("Error: No InnerTubeContext shell provided in ytconfig.")),d={};d={context:d};if(O=this.h(a)){this.i(d,O,b);var ba,da;b="/youtubei/v1/"+cr(this.j());(a=null===(da=null===(ba=a.commandMetadata)||
void 0===ba?void 0:ba.webCommandMetadata)||void 0===da?void 0:da.apiUrl)&&(b=a);ba=b;(da=B("INNERTUBE_HOST_OVERRIDE"))&&(ba=String(da)+String(ec(ba)));da={};da.key=B("INNERTUBE_API_KEY");M("json_condensed_response")&&(da.prettyPrint="false");ba=rj(ba,da||{},!1);ba={input:ba,ra:dr(ba),ba:d,config:Object.assign({},void 0)};ba.config.Ga?ba.config.Ga.identity=c:ba.config.Ga={identity:c};return ba}Rp(new P("Error: Failed to create Request from Command.",a))};
...
Xr[Xr.PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT]="PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT";Xr[Xr.PLAYER_ROTATION_TYPE_UNKNOWN]="PLAYER_ROTATION_TYPE_UNKNOWN";var Yr="actionVisualElement spinnerInfo resourceInfo playerInfo commentInfo mdxInfo watchInfo thumbnailLoadInfo creatorInfo unpluggedInfo reelInfo subscriptionsFeedInfo requestIds mediaBrowserActionInfo musicLoadActionInfo shoppingInfo prefetchInfo accelerationSession webInfo tvInfo kabukiInfo mwebInfo musicInfo".split(" ");var Zr=y.ytLoggingLatencyUsageStats_||{};z("ytLoggingLatencyUsageStats_",Zr,void 0);function $r(){this.h=0}
function as(){$r.h||($r.h=new $r);return $r.h}
$r.prototype.tick=function(a,b,c,d){bs(this,"tick_"+a+"_"+b)||(c={timestamp:c,cttAuthInfo:d},M("web_csi_via_jspb")?(d=new Ah,D(d,1,a),D(d,2,b),a=new Dh,hd(a,5,Eh,d),Dp(a,c)):wl("latencyActionTicked",{tickName:a,clientActionNonce:b},c))};
$r.prototype.info=function(a,b,c){var d=Object.keys(a).join("");bs(this,"info_"+d+"_"+b)||(a=Object.assign({},a),a.clientActionNonce=b,wl("latencyActionInfo",a,{cttAuthInfo:c}))};
$r.prototype.jspbInfo=function(a,b,c){for(var d="",e=0;e<a.toJSON().length;e++)void 0!==a.toJSON()[e]&&(d=0===e?d.concat(""+e):d.concat("_"+e));bs(this,"info_"+d+"_"+b)||(D(a,2,b),b={cttAuthInfo:c},c=new Dh,hd(c,7,Eh,a),Dp(c,b))};
$r.prototype.span=function(a,b,c){var d=Object.keys(a).join("");bs(this,"span_"+d+"_"+b)||(a.clientActionNonce=b,wl("latencyActionSpan",a,{cttAuthInfo:c}))};
function bs(a,b){Zr[b]=Zr[b]||{count:0};var c=Zr[b];c.count++;c.time=Q();a.h||(a.h=Bi(function(){var d=Q(),e;for(e in Zr)Zr[e]&&6E4<d-Zr[e].time&&delete Zr[e];a&&(a.h=0)},5E3));
...
break;case "adNetworks":D(c,37,a[e]);break;case "previousAction":D(c,13,V[a[e]]);break;case "isRedSubscriber":D(c,14,a[e]);break;case "serverTimeMs":D(c,15,a[e]);break;case "videoId":c.setVideoId(a[e]);break;case "adVideoId":D(c,20,a[e]);break;case "targetVideoId":D(c,78,a[e]);break;case "adBreakType":D(c,21,Sr[a[e]]);break;case "isNavigation":D(c,25,a[e]);break;case "viewportHeight":D(c,29,a[e]);break;case "viewportWidth":D(c,30,a[e]);break;case "screenHeight":D(c,84,a[e]);break;case "screenWidth":D(c,
...
63,a[e]);break;case "getLibraryRequestId":D(c,66,a[e]);break;default:Yr.includes(f)&&mi(new P("Codegen laipb translator asked to translate message field",""+f))}}catch(g){mi(Error("Codegen laipb translator failed to set "+f))}}gs(c,b)}}
...
function Z(a,b,c){if(!b&&"_"!==a[0]){var d=a;S.mark&&(0==d.lastIndexOf("mark_",0)||(d="mark_"+d),c&&(d+=" ("+c+")"),S.mark(d))}Hr(c||"").tick[a]=b||Q();d=Ar(c);d.gelTicks&&(d.gelTicks[a]=!0);d=ur(c);var e=b||Q();d[a]=e;e=Cr(c);var f=yr(c).cttAuthInfo;if("_start"===a){var g=as();bs(g,"baseline_"+e)||(b={timestamp:b,cttAuthInfo:f},M("web_csi_via_jspb")?(f=new uh,D(f,1,e),e=new Dh,hd(e,6,Eh,f),Dp(e,b)):wl("latencyActionBaselined",{clientActionNonce:e},b))}else as().tick(a,e,b,f);Dr(c);return d[a]}
function hs(){var a=Cr(void 0);requestAnimationFrame(function(){setTimeout(function(){a===Cr(void 0)&&Z("ol",void 0,void 0)},0)})}
function is(){var a=document;if("visibilityState"in a)a=a.visibilityState;else{var b=ii+"VisibilityState";a=b in a?a[b]:void 0}switch(a){case "hidden":return 0;case "visible":return 1;case "prerender":return 2;case "unloaded":return 3;default:return-1}}
...
f.domainLookupEnd,void 0));0<f.connectEnd-f.connectStart&&(Z("ntcps",f.connectStart,void 0),Z("ntcpe",f.connectEnd,void 0));f.secureConnectionStart>=xr()&&0<f.connectEnd-f.secureConnectionStart&&(Z("nstcps",f.secureConnectionStart,void 0),Z("ntcpe",f.connectEnd,void 0));S&&"getEntriesByType"in S&&js()}
var b=B("TIMING_INFO",{});if(M("web_csi_via_jspb")){b=ks(b);gs(b);b=new wh;D(b,25,!0);D(b,1,V[Or(B("TIMING_ACTION",void 0))]);var c=B("PREVIOUS_ACTION",void 0);c&&D(b,13,V[Or(c)]);(c=B("CLIENT_PROTOCOL"))&&D(b,33,c);(c=B("CLIENT_TRANSPORT"))&&D(b,34,c);(c=jq())&&"UNDEFINED_CSN"!==c&&D(b,4,c);c=is();1!==c&&-1!==c||D(b,6,!0);c=zr();D(b,3,"cold");a(c);c=ls();if(0<c.length){c=q(c);for(var d=c.next();!d.done;d=c.next()){d=d.value;var e=new vh;D(e,1,d);id(b,83,vh,e)}}gs(b)}else{for(c in b)b.hasOwnProperty(c)&&
fs(c,b[c]);b={isNavigation:!0,actionType:Or(B("TIMING_ACTION",void 0))};if(c=B("PREVIOUS_ACTION",void 0))b.previousAction=Or(c);if(c=B("CLIENT_PROTOCOL"))b.httpProtocol=c;if(c=B("CLIENT_TRANSPORT"))b.transportProtocol=c;(c=jq())&&"UNDEFINED_CSN"!==c&&(b.clientScreenNonce=c);c=is();if(1===c||-1===c)b.isVisible=!0;c=zr();b.loadType="cold";a(c);c=ls();if(0<c.length)for(b.resourceInfo=[],c=q(c),d=c.next();!d.done;d=c.next())b.resourceInfo.push({resourceCache:d.value});es(b)}}
function ks(a){var b=new wh;a=q(Object.entries(a));for(var c=a.next();!c.done;c=a.next()){var d=q(c.value);c=d.next().value;d=d.next().value;switch(c){case "GetBrowse_rid":var e=new zh;D(e,1,c);D(e,2,String(d));yh(b,e);break;case "GetGuide_rid":e=new zh;D(e,1,c);D(e,2,String(d));yh(b,e);break;case "GetHome_rid":e=new zh;D(e,1,c);D(e,2,String(d));yh(b,e);break;case "GetPlayer_rid":e=new zh;D(e,1,c);D(e,2,String(d));yh(b,e);break;case "GetSearch_rid":e=new zh;D(e,1,c);D(e,2,String(d));yh(b,e);break;
...
function ls(){var a=[];if(document.querySelector&&S&&S.getEntriesByName)for(var b in sr)if(sr.hasOwnProperty(b)){var c=sr[b];ms(b,c)&&a.push(c)}return a}
function js(){var a=window.location.protocol,b=S.getEntriesByType("resource");b=fb(b,function(c){return 0===c.name.indexOf(a+"//web.archive.org/web/20220308204523/https://fonts.gstatic.com/s/")});
...
var ns=window;ns.ytcsi&&(ns.ytcsi.info=fs,ns.ytcsi.tick=Z);var os=["consistency","mss","client_location","entities","store"];function ps(a,b,c,d){this.o=a;this.J=b;this.l=c;this.j=d;this.i=void 0;this.h=new Map;a.za||(a.za={});a.za=Object.assign(Object.assign({},hr),a.za)}
function qs(a,b,c,d){if(void 0!==ps.h){if(d=ps.h,a=[a!==d.o,b!==d.J,c!==d.l,!1,!1,void 0!==d.i],a.some(function(e){return e}))throw new P("InnerTubeTransportService is already initialized",a);
}else ps.h=new ps(a,b,c,d)}
function rs(a){var b={signalServiceEndpoint:{signal:"GET_DATASYNC_IDS"}};var c=void 0===c?Qq:c;var d=Zq(b,a.o);if(!d)return eg(new P("Error: No request builder found for command.",b));var e=d.o(b,void 0,c);return e?new $f(function(f){var g,h,k;return w(function(m){if(1==m.h){h="cors"===(null===(g=e.ra)||void 0===g?void 0:g.mode)?"cors":void 0;if(a.l.zc){var p=e.config,v;p=null===(v=null===p||void 0===p?void 0:p.Ga)||void 0===v?void 0:v.sessionIndex;v=Hq({sessionIndex:p});k=Object.assign(Object.assign({},
ss(h)),v);return m.s(2)}return t(m,ts(e.config,h),3)}2!=m.h&&(k=m.i);f(us(a,e,k));m.h=0})}):eg(new P("Error: Failed to build request for command.",b))}
function us(a,b,c){var d,e,f,g,h,k,m,p,v,x,u,E,F,K,O,N,R;return w(function(W){switch(W.h){case 1:W.s(2);break;case 3:if((m=W.i)&&!m.isExpired())return W.return(Promise.resolve(m.h()));case 2:if((p=null===(d=b.config)||void 0===d?void 0:d.No)&&a.h.has(p)&&M("web_memoize_inflight_requests"))return W.return(a.h.get(p));if(null===(e=null===b||void 0===b?void 0:b.ba)||void 0===e?0:e.context)for(v=q([]),x=v.next();!x.done;x=v.next())u=x.value,u.Lo(b.ba.context);if(null===(f=a.i)||void 0===f?0:f.l(b.input,
b.ba))return W.return(a.i.j(b.input,b.ba));E=JSON.stringify(b.ba);b.ra=Object.assign(Object.assign({},b.ra),{headers:c});F=Object.assign({},b.ra);"POST"===b.ra.method&&(F=Object.assign(Object.assign({},F),{body:E}));(null===(g=b.config)||void 0===g?0:g.kc)&&Z(b.config.kc);K=a.J.fetch(b.input,F,b.config);p&&a.h.set(p,K);return t(W,K,4);case 4:O=W.i;p&&a.h.has(p)&&a.h.delete(p);(null===(h=b.config)||void 0===h?0:h.lc)&&Z(b.config.lc);if(O||null===(k=a.i)||void 0===k||!k.h(b.input,b.ba)){W.s(5);break}return t(W,
a.i.i(b.input,b.ba),6);case 6:O=W.i;case 5:if(O&&a.j)for(N=q(os),x=N.next();!x.done;x=N.next())R=x.value,a.j[R]&&a.j[R].handleResponse(O,b);return W.return(O)}})}
function ts(a,b){var c,d,e;return w(function(f){if(1==f.h){d=null===(c=null===a||void 0===a?void 0:a.Ga)||void 0===c?void 0:c.sessionIndex;var g=Hq({sessionIndex:d});if(!(g instanceof $f)){var h=new $f(Ma);ag(h,2,g);g=h}return t(f,g,2)}e=f.i;return f.return(Promise.resolve(Object.assign(Object.assign({},ss(b)),e)))})}
...
fa.Object.defineProperties(Bs.prototype,{l:{configurable:!0,enumerable:!0,get:function(){return!0}}});function Cs(){}
...
return b};
Hs[Iq]=[new Kq];var Is=new Jq("NETWORK_MANAGER_TOKEN");var Js;function Ks(a){bn.call(this,1,arguments);this.csn=a}
r(Ks,bn);var ln=new cn("screen-created",Ks),Ls=[],Ns=Ms,Os=0;function Ps(a,b,c,d,e,f,g){function h(){Sp(new P("newScreen() parent element does not have a VE - rootVe",b))}
var k=Ns();f=new cq({veType:b,youtubeData:f,jspbYoutubeData:void 0});e={cttAuthInfo:e,W:k};if(M("il_via_jspb")){var m=new kh;m.X(k);lh(m,f.getAsJspb());c&&c.visualElement?(f=new mh,c.clientScreenNonce&&D(f,2,c.clientScreenNonce),nh(f,c.visualElement.getAsJspb()),g&&D(f,4,jh[g]),H(m,5,f)):c&&h();d&&D(m,3,d);Ip(m,e,a)}else f={csn:k,pageVe:f.getAsJson()},c&&c.visualElement?(f.implicitGesture={parentCsn:c.clientScreenNonce,gesturedVe:c.visualElement.getAsJson()},g&&(f.implicitGesture.gestureType=g)):
c&&h(),d&&(f.cloneCsn=d),a?Ek("screenCreated",f,a,e):wl("screenCreated",f,e);hn(ln,new Ks(k));return k}
function Qs(a,b,c,d){var e=d.filter(function(k){k.csn!==b?(k.csn=b,k=!0):k=!1;return k}),f={cttAuthInfo:lq(b),
W:b};d=q(d);for(var g=d.next();!g.done;g=d.next())g=g.value.getAsJson(),(pb(g)||!g.trackingParams&&!g.veType)&&Sp(Error("Child VE logged with no data"));if(M("il_via_jspb")){var h=new oh;h.X(b);qh(h,c.getAsJspb());gb(e,function(k){k=k.getAsJspb();id(h,3,hh,k)});
"UNDEFINED_CSN"==b?Rs("visualElementAttached",h,f):Jp(h,f,a)}else c={csn:b,parentVe:c.getAsJson(),childVes:gb(e,function(k){return k.getAsJson()})},"UNDEFINED_CSN"==b?Rs("visualElementAttached",c,f):a?Ek("visualElementAttached",c,a,f):wl("visualElementAttached",c,f)}
function Ms(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return Lc(b,3)}
function Rs(a,b,c){Ls.push({payloadName:a,payload:b,options:c});Os||(Os=mn())}
function nn(a){if(Ls){for(var b=q(Ls),c=b.next();!c.done;c=b.next())if(c=c.value,c.payload)if(M("il_via_jspb"))switch(c.payload.X(a.csn),c.payloadName){case "screenCreated":Ip(c.payload,c.options);break;case "visualElementAttached":Jp(c.payload,c.options);break;case "visualElementShown":Ep(c.payload,c.options);break;case "visualElementHidden":Fp(c.payload,c.options);break;case "visualElementGestured":Gp(c.payload,c.options);break;case "visualElementStateChanged":Hp(c.payload,c.options);break;default:Sp(new P("flushQueue unable to map payloadName to JSPB setter"))}else c.payload.csn=
a.csn,Ek(c.payloadName,c.payload,null,c.options);Ls.length=0}Os=0}
...
Na(Ss);function Ts(){this.o=[];this.C=[];this.h=[];this.l=[];this.m=[];this.i=new Set;this.u=new Map}
function Us(a,b,c){c=void 0===c?0:c;b.then(function(d){var e,f;a.i.has(c)&&a.j&&a.j();var g=jq(c),h=hq(c);g&&h&&((null===(e=null===d||void 0===d?void 0:d.response)||void 0===e?0:e.trackingParams)&&Qs(a.client,g,h,[dq(d.response.trackingParams)]),(null===(f=null===d||void 0===d?void 0:d.playerResponse)||void 0===f?0:f.trackingParams)&&Qs(a.client,g,h,[dq(d.playerResponse.trackingParams)]))})}
function Vs(a,b,c,d){d=void 0===d?0:d;if(a.i.has(d))a.o.push([b,c]);else{var e=jq(d);c=c||hq(d);e&&c&&Qs(a.client,e,c,[b])}}
Ts.prototype.clickCommand=function(a,b,c){a:{var d=a.clickTrackingParams;c=void 0===c?0:c;c=void 0===c?0:c;if(d){if(M("web_ignore_no_ve_clicks")&&(a=wp(atob(d.replace(/-/g,"+").replace(/_/g,"/"))),!a||0===a)){b=!1;break a}if(c=jq(c)){a=this.client;var e=dq(d);var f="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";d={cttAuthInfo:lq(c),W:c};if(M("il_via_jspb")){var g=new rh;g.X(c);e=e.getAsJspb();H(g,2,e);D(g,4,jh[f]);b&&H(g,3,void 0);"UNDEFINED_CSN"==c?Rs("visualElementGestured",g,d):Gp(g,d,a)}else f=
{csn:c,ve:e.getAsJson(),gestureType:f},b&&(f.clientData=b),"UNDEFINED_CSN"==c?Rs("visualElementGestured",f,d):a?Ek("visualElementGestured",f,a,d):wl("visualElementGestured",f,d);b=!0}else b=!1}else b=!1}return b};
function Ws(a,b,c){c=void 0===c?{}:c;a.i.add(c.layer||0);a.j=function(){Xs(a,b,c);var f=hq(c.layer);if(f){for(var g=q(a.o),h=g.next();!h.done;h=g.next())h=h.value,Vs(a,h[0],h[1]||f,c.layer);f=q(a.C);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=jq(g);var m=k[0]||hq(g);if(h&&m){g=a.client;var p=k[1];k={cttAuthInfo:lq(h),W:h};M("il_via_jspb")?(p=new th,p.X(h),m=m.getAsJspb(),H(p,2,m),"UNDEFINED_CSN"==h?Rs("visualElementStateChanged",p,k):Hp(p,k,g)):(m={csn:h,ve:m.getAsJson(),
clientData:p},"UNDEFINED_CSN"==h?Rs("visualElementStateChanged",m,k):g?Ek("visualElementStateChanged",m,g,k):wl("visualElementStateChanged",m,k))}}}};
jq(c.layer)||a.j();if(c.sb)for(var d=q(c.sb),e=d.next();!e.done;e=d.next())Us(a,e.value,c.layer);else Rp(Error("Delayed screen needs a data promise."))}
function Xs(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.ec?c.ec:c.layer;var e=jq(d);d=hq(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=B("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=Ps(a.client,b,f,c.rb,c.cttAuthInfo,g,c.Io)}catch(m){Up(m,{Oo:b,rootVe:d,parentVisualElement:void 0,Fo:e,Ko:f,rb:c.rb});Rp(m);return}mq(k,b,
c.layer,c.cttAuthInfo);if(b=e&&"UNDEFINED_CSN"!==e&&d){a:{b=q(Object.values(bq));for(f=b.next();!f.done;f=b.next())if(jq(f.value)==e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,g=!0,h=(g=void 0===g?!1:g)?16:8,f={cttAuthInfo:lq(e),W:e,ub:g},M("il_via_jspb")?(h=new sh,h.X(e),d=d.getAsJspb(),H(h,2,d),D(h,4,g?16:8),"UNDEFINED_CSN"==e?Rs("visualElementHidden",h,f):Fp(h,f,b)):(d={csn:e,ve:d.getAsJson(),eventType:h},"UNDEFINED_CSN"==e?Rs("visualElementHidden",d,f):b?Ek("visualElementHidden",d,b,f):wl("visualElementHidden",
d,f)));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=k||"");es({clientScreenNonce:k});Ss.getInstance().clear();d=hq(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(M("web_mark_root_visible")||M("music_web_mark_root_visible"))&&(e=k,k={cttAuthInfo:lq(e),W:e},M("il_via_jspb")?(b=new sh,b.X(e),f=d.getAsJspb(),H(b,2,f),D(b,4,1),"UNDEFINED_CSN"==e?Rs("visualElementShown",b,k):Ep(b,k,void 0)):(b={csn:e,ve:d.getAsJson(),eventType:1},"UNDEFINED_CSN"==e?Rs("visualElementShown",b,k):wl("visualElementShown",
b,k)));a.i.delete(c.layer||0);a.j=void 0;e=q(a.u);for(k=e.next();!k.done;k=e.next())b=q(k.value),k=b.next().value,b=b.next().value,b.has(c.layer)&&d&&Vs(a,k,d,c.layer);for(c=0;c<a.l.length;c++){e=a.l[c];try{e()}catch(m){Rp(m)}}for(c=a.l.length=0;c<a.m.length;c++){e=a.m[c];try{e()}catch(m){Rp(m)}}}
...
;var Zs=y.caches,$s;function at(a){var b=a.indexOf(":");return-1===b?{Cb:a}:{Cb:a.substring(0,b),datasyncId:a.substring(b+1)}}
function bt(){return w(function(a){if(void 0!==$s)return a.return($s);$s=new Promise(function(b){var c;return w(function(d){switch(d.h){case 1:return ua(d,2),t(d,Zs.open("test-only"),4);case 4:return t(d,Zs.delete("test-only"),5);case 5:wa(d,3);break;case 2:if(c=xa(d),c instanceof Error&&"SecurityError"===c.name)return b(!1),d.return();case 3:b("caches"in window),d.h=0}})});
return a.return($s)})}
function ct(a){var b,c,d,e,f,g,h;w(function(k){if(1==k.h)return t(k,bt(),2);if(3!=k.h){if(!k.i)return k.return(!1);b=[];return t(k,Zs.keys(),3)}c=k.i;d=q(c);for(e=d.next();!e.done;e=d.next())f=e.value,g=at(f),h=g.datasyncId,!h||a.includes(h)||b.push(Zs.delete(f));return k.return(Promise.all(b).then(function(m){return m.some(function(p){return p})}))})}
function dt(){var a,b,c,d,e,f,g;return w(function(h){if(1==h.h)return t(h,bt(),2);if(3!=h.h){if(!h.i)return h.return(!1);a=Al("cache contains other");return t(h,Zs.keys(),3)}b=h.i;c=q(b);for(d=c.next();!d.done;d=c.next())if(e=d.value,f=at(e),(g=f.datasyncId)&&g!==a)return h.return(!0);return h.return(!1)})}
;function et(){try{return!!self.localStorage}catch(a){return!1}}
;function ft(a){a=a.match(/(.*)::.*::.*/);if(null!==a)return a[1]}
function gt(a){if(et()){var b=Object.keys(window.localStorage);b=q(b);for(var c=b.next();!c.done;c=b.next()){c=c.value;var d=ft(c);void 0===d||a.includes(d)||self.localStorage.removeItem(c)}}}
function ht(){if(!et())return!1;var a=Al(),b=Object.keys(window.localStorage);b=q(b);for(var c=b.next();!c.done;c=b.next())if(c=ft(c.value),void 0!==c&&c!==a)return!0;return!1}
;function jt(){Ys().then(function(a){a&&(Km(a),ct(a),gt(a))})}
function kt(){var a=new Mo;bf.N(function(){var b,c,d,e;return w(function(f){switch(f.h){case 1:if(M("ytidb_clear_optimizations_killswitch")){f.s(2);break}b=Al("clear");if(b.startsWith("V")){var g=[b];Km(g);ct(g);gt(g);return f.return()}c=ht();return t(f,dt(),3);case 3:return d=f.i,t(f,Lm(),4);case 4:if(e=f.i,!c&&!d&&!e)return f.return();case 2:a.H()?jt():a.l.add("publicytnetworkstatus-online",jt,!0,void 0,void 0),f.h=0}})})}
...
function st(a,b,c){c=void 0===c?null:c;var d=tt(a),e=document.getElementById(d),f=e&&nt(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=Pj(d,b),b=""+Ra(b),ut[b]=f),g||(e=vt(a,d,function(){nt(e,"loaded")||(lt(e),Sj(d),xi(Xa(Tj,d),0))},c)))}
...
function wt(a){a=tt(a);var b=document.getElementById(a);b&&(Tj(a),b.parentNode.removeChild(b))}
function xt(a,b){a&&b&&(a=""+Ra(b),(a=ut[a])&&Rj(a))}
...
try{rt("//web.archive.org/web/20220308204523/https://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}zt.push(bf.N(function(){if(!(At||"google_ad_status"in window)){try{xt("//web.archive.org/web/20220308204523/https://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}At=!0;Zh("DCLKSTAT",3)}},5E3))}}
function Ct(){var a=Number(B("DCLKSTAT",0));return isNaN(a)?0:a}
...
Et(this,f,g,a.program,b,c)}else Sp(Error("Cannot initialize botguard without program"))};
function Et(a,b,c,d,e,f){var g=void 0===g?"trayride":g;c?(a.state=2,rt(c,function(){window[g]?Ht(a,d,g,e):(a.state=3,wt(c),Sp(new P("Unable to load Botguard","from "+c)))},f)):b?(f=Md("SCRIPT"),f.textContent=b,f.nonce=Yb(),document.head.appendChild(f),document.head.removeChild(f),window[g]?Ht(a,d,g,e):(a.state=4,Sp(new P("Unable to load Botguard from JS")))):Sp(new P("Unable to load VM; no url or JS provided"))}
...
l.invoke=function(a){a=void 0===a?{}:a;if(this.h){var b=this.h;a={qb:a};if(b.i)throw Error("Already disposed");b=b.l([a.qb,a.yc])}else b=null;return b};
...
;function Mt(a){var b=this;var c=void 0===c?0:c;var d=void 0===d?Gi():d;this.l=c;this.j=d;this.i=new Ad;this.h=a;a={};c=q(this.h.entries());for(d=c.next();!d.done;a={sa:a.sa,Ba:a.Ba},d=c.next()){var e=q(d.value);d=e.next().value;e=e.next().value;a.Ba=d;a.sa=e;d=function(f){return function(){f.sa.fb();b.h[f.Ba].Sa=!0;b.h.every(function(g){return!0===g.Sa})&&b.i.resolve()}}(a);
e=Ci(d,Nt(this,a.sa));this.h[a.Ba]=Object.assign(Object.assign({},a.sa),{fb:d,Na:e})}}
function Ot(a){var b=Array.from(a.h.keys()).sort(function(d,e){return Nt(a,a.h[e])-Nt(a,a.h[d])});
b=q(b);for(var c=b.next();!c.done;c=b.next())c=a.h[c.value],void 0===c.Na||c.Sa||(a.j.T(c.Na),Ci(c.fb,10))}
Mt.prototype.cancel=function(){for(var a=q(this.h),b=a.next();!b.done;b=a.next())b=b.value,void 0===b.Na||b.Sa||this.j.T(b.Na),b.Sa=!0;this.i.resolve()};
function Nt(a,b){var c;return null!==(c=b.priority)&&void 0!==c?c:a.l}
;function Pt(a){this.state=a;this.plugins=[];this.m=void 0}
Pt.prototype.install=function(){this.plugins.push.apply(this.plugins,ja(Ha.apply(0,arguments)))};
...
function Qt(a,b,c){return function(){var d=Ha.apply(0,arguments),e=b.filter(function(k){var m;return 10===(null!==(m=null!==c&&void 0!==c?c:k.priority)&&void 0!==m?m:0)}),f=b.filter(function(k){var m;
return 10!==(null!==(m=null!==c&&void 0!==c?c:k.priority)&&void 0!==m?m:0)});
Gi();var g={};e=q(e);for(var h=e.next();!h.done;g={Ca:g.Ca},h=e.next())g.Ca=h.value,Ei(function(k){return function(){k.Ca.ka.apply(k.Ca,ja(d))}}(g));
f=f.map(function(k){var m;return{fb:function(){k.ka.apply(k,ja(d))},
priority:null!==(m=null!==c&&void 0!==c?c:k.priority)&&void 0!==m?m:0}});
f.length&&(a.j=new Mt(f))}}
fa.Object.defineProperties(Pt.prototype,{currentState:{configurable:!0,enumerable:!0,get:function(){return this.state}}});function Rt(a){Pt.call(this,void 0===a?"document_active":a);var b=this;this.m=10;this.h=new Map;this.C=[{from:"document_active",B:"document_disposed_preventable",action:this.u},{from:"document_active",B:"document_disposed",action:this.l},{from:"document_disposed_preventable",B:"document_disposed",action:this.l},{from:"document_disposed_preventable",B:"flush_logs",action:this.o},{from:"document_disposed_preventable",B:"document_active",action:this.i},{from:"document_disposed",B:"flush_logs",action:this.o},
...
r(Rt,Pt);
Rt.prototype.u=function(a,b){var c,d;if(!this.h.get("document_disposed_preventable")&&(a(null===b||void 0===b?void 0:b.event),(null===(c=null===b||void 0===b?void 0:b.event)||void 0===c?0:c.defaultPrevented)||(null===(d=null===b||void 0===b?void 0:b.event)||void 0===d?0:d.returnValue))){b.event.returnValue||(b.event.returnValue=!0);b.event.defaultPrevented||b.event.preventDefault();this.h=new Map;this.transition("document_active");return}this.h.set("document_disposed_preventable",!0);this.h.get("document_disposed")?this.transition("flush_logs"):
this.transition("document_disposed")};
Rt.prototype.l=function(a,b){this.h.get("document_disposed")?this.transition("document_active"):(a(null===b||void 0===b?void 0:b.event),this.h.set("document_disposed",!0),this.transition("flush_logs"))};
Rt.prototype.o=function(a,b){a(null===b||void 0===b?void 0:b.event);this.transition("document_active")};
...
r(St,Pt);St.prototype.i=function(a,b){a(null===b||void 0===b?void 0:b.event);M("visibility_lifecycles_dynamic_backgrounding")&&this.transition("document_foregrounded")};
St.prototype.h=function(a,b){a(null===b||void 0===b?void 0:b.event);M("visibility_lifecycles_dynamic_backgrounding")&&this.transition("document_backgrounded")};
St.prototype.l=function(a,b){a(null===b||void 0===b?void 0:b.event)};
St.prototype.o=function(a,b){a(null===b||void 0===b?void 0:b.event)};function Tt(){this.h=new Rt;this.i=new St}
Tt.prototype.install=function(){var a=Ha.apply(0,arguments);this.h.install.apply(this.h,ja(a));this.i.install.apply(this.i,ja(a))};function Ut(){Tt.call(this);var a={};this.install((a.document_disposed={ka:this.j},a));a={};this.install((a.flush_logs={ka:this.l},a))}
var Vt;r(Ut,Tt);Ut.prototype.l=function(){wl("finalPayload",{csn:jq()})};
Ut.prototype.j=function(){Wp(Xp)};function Wt(){}
Wt.getInstance=function(){var a=A("ytglobal.storage_");a||(a=new Wt,z("ytglobal.storage_",a,void 0));return a};
Wt.prototype.estimate=function(){var a,b,c;return w(function(d){c=navigator;return(null===(a=c.storage)||void 0===a?0:a.estimate)?d.return(c.storage.estimate()):(null===(b=c.webkitTemporaryStorage)||void 0===b?0:b.queryUsageAndQuota)?d.return(Xt()):d.return()})};
function Xt(){var a=navigator;return new Promise(function(b,c){var d;null!==(d=a.webkitTemporaryStorage)&&void 0!==d&&d.queryUsageAndQuota?a.webkitTemporaryStorage.queryUsageAndQuota(function(e,f){b({usage:e,quota:f})},function(e){c(e)}):c(Error("webkitTemporaryStorage is not supported."))})}
z("ytglobal.storageClass_",Wt,void 0);function ul(a,b){var c=this;this.handleError=a;this.h=b;this.i=!1;void 0===self.document||self.addEventListener("beforeunload",function(){c.i=!0});
...
function Yt(a,b){Wt.getInstance().estimate().then(function(c){c=Object.assign(Object.assign({},b),{isSw:void 0===self.document,isIframe:self!==self.top,deviceStorageUsageMbytes:Zt(null===c||void 0===c?void 0:c.usage),deviceStorageQuotaMbytes:Zt(null===c||void 0===c?void 0:c.quota)});a.h("idbQuotaExceeded",c)})}
function Zt(a){return"undefined"===typeof a?"-1":String(Math.ceil(a/1048576))}
;var $t=window;
function au(){var a=$t.uaChPolyfill.state;if(0===a.type)wl("clientHintsPolyfillEvent",{clientHintsSupported:!1});else{var b=navigator.userAgent,c=void 0!==a.syntheticUa&&a.syntheticUa===b,d={clientHintsSupported:!0,uaAccessedBeforePolyfill:a.didAccessUaBeforePolyfillAvailable,syntheticUaMatches:c};a.didAccessUaBeforePolyfillAvailable&&(d.uaAccessBeforePolyfillCount=a.uaAccessBeforePolyfillCount,a.firstAccessUaError&&(d.firstUaAccessStack=String(a.firstAccessUaError.stack).replace(/\n/g,""),Rp(a.firstAccessUaError)),
...
b))}}
var bu=!1;function cu(){var a;1===(null===(a=$t.uaChPolyfill)||void 0===a?void 0:a.state.type)?bu||($t.uaChPolyfill.onReady=cu,bu=!0):$t.uaChPolyfill&&au()}
;function du(a,b,c){J.call(this);var d=this;c=c||B("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.j=b||null;this.L="*";this.l=c;this.sessionId=null;this.channel="widget";this.M=!!a;this.A=function(e){a:if(!("*"!=d.l&&e.origin!=d.l||d.j&&e.source!=d.j||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.M&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
r(du,J);du.prototype.sendMessage=function(a,b){if(b=b||this.j){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var c=JSON.stringify(a);b.postMessage(c,this.L)}catch(d){ni(d)}}};
du.prototype.I=function(){window.removeEventListener("message",this.A);J.prototype.I.call(this)};function eu(){this.i=[];this.isReady=!1;this.j={};var a=this.h=new du(!!B("WIDGET_ID_ENFORCE")),b=this.ic.bind(this);a.m=b;a.u=null;this.h.channel="widget";if(a=B("WIDGET_ID"))this.h.sessionId=a}
l=eu.prototype;l.ic=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.j[a]||"onReady"===a||(this.addEventListener(a,fu(this,a)),this.j[a]=!0)):this.lb(a,b,c)};
l.lb=function(){};
function fu(a,b){return function(c){return a.sendMessage(b,c)}}
l.addEventListener=function(){};
l.Vb=function(){this.isReady=!0;this.sendMessage("initialDelivery",this.Ya());this.sendMessage("onReady");eb(this.i,this.Ib,this);this.i=[]};
...
function ju(a,b,c,d){if(Qa(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
...
l.lb=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&hu(a)){var d=b;if(Qa(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=iu(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
d[2];break b}d=null}e.videoId=d;e=iu(e);break;case "loadPlaylist":case "cuePlaylist":e=ju(d[0],d[1],d[2],d[3])}b.length=1;b[0]=e}this.api.handleExternalCall(a,b,c);hu(a)&&gu(this,this.Ya())}};
...
l.dispose=function(){eu.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function lu(a){J.call(this);this.i={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.Eb,this)}
r(lu,J);l=lu.prototype;l.start=function(){this.started||this.h()||(this.started=!0,this.connection.la("RECEIVING"))};
...
l.nc=function(a,b){this.started&&!this.h()&&this.connection.la(a,this.Xa(a,b))};
...
l.I=function(){var a=this.connection;a.h()||rg(a.i,"command",this.Eb,this);this.connection=null;for(var b in this.i)this.i.hasOwnProperty(b)&&this.removeListener(b);J.prototype.I.call(this)};function ou(a,b){lu.call(this,b);this.api=a;this.start()}
...
ou.prototype.Xa=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return lu.prototype.Xa.call(this,a,b)};
ou.prototype.I=function(){lu.prototype.I.call(this);delete this.api};function pu(a){a=void 0===a?!1:a;J.call(this);this.i=new L(a);re(this,Xa(pe,this.i))}
Za(pu,J);pu.prototype.subscribe=function(a,b,c){return this.h()?0:this.i.subscribe(a,b,c)};
...
qu.prototype.I=function(){this.destination=this.j=null;pu.prototype.I.call(this)};function ru(a,b,c){J.call(this);this.destination=a;this.origin=c;this.i=ui(window,"message",this.j.bind(this));this.connection=new qu(this,a,b);re(this,Xa(pe,this.connection))}
r(ru,J);ru.prototype.la=function(a,b,c,d){this.h()||a!==this.destination||(a={id:b,command:c},d&&(a.data=d),this.destination.postMessage(Rf(a),this.origin))};
ru.prototype.j=function(a){var b;if(b=!this.h())if(b=a.origin===this.origin)a:{b=this.destination;do{b:{var c=a.source;do{if(c===b){c=!0;break b}if(c===c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.connection,c.h()||c.l("command",b.command,b.data,a.origin))}};
ru.prototype.I=function(){vi(this.i);this.destination=null;J.prototype.I.call(this)};function su(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||vb(b);this.assets=a.assets||{};this.attrs=a.attrs||vb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
su.prototype.clone=function(){var a=new su,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Oa(c)?a[b]=vb(c):a[b]=c}return a};var tu=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function uu(a){a=a||"";if(window.spf){var b=a.match(tu);spf.style.load(a,b?b[1]:"",void 0)}else vu(a)}
function vu(a){var b=wu(a),c=document.getElementById(b),d=c&&nt(c,"loaded");d||c&&!d||(c=xu(a,b,function(){nt(c,"loaded")||(lt(c),Sj(b),xi(Xa(Tj,b),0))}))}
...
;function yu(){J.call(this);this.i=[]}
r(yu,J);yu.prototype.I=function(){for(;this.i.length;){var a=this.i.pop();a.target.removeEventListener(a.name,a.ka,void 0)}J.prototype.I.call(this)};function zu(){yu.apply(this,arguments)}
r(zu,yu);function Au(a,b,c,d){J.call(this);var e=this;this.M=b;this.webPlayerContextConfig=d;this.Ua=!1;this.api={};this.Da=this.u=null;this.S=new L;this.i={};this.fa=this.Ea=this.elementId=this.Va=this.config=null;this.Y=!1;this.l=this.A=null;this.Fa={};this.Mb=["onReady"];this.lastError=null;this.mb=NaN;this.L={};this.Nb=new zu(this);this.na=0;this.j=this.m=a;re(this,Xa(pe,this.S));Bu(this);Cu(this);re(this,Xa(pe,this.Nb));c?this.na=xi(function(){e.loadNewVideoConfig(c)},0):d&&(Du(this),Eu(this))}
r(Au,J);l=Au.prototype;l.getId=function(){return this.M};
l.loadNewVideoConfig=function(a){if(!this.h()){this.na&&(yi(this.na),this.na=0);var b=a||{};b instanceof su||(b=new su(b));this.config=b;this.setConfig(a);Eu(this);this.isReady()&&Fu(this)}};
function Du(a){var b,c;a.webPlayerContextConfig?c=a.webPlayerContextConfig.rootElementId:c=a.config.attrs.id;a.elementId=c||a.elementId;"video-player"===a.elementId&&(a.elementId=a.M,a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.M:a.config.attrs.id=a.M);(null===(b=a.j)||void 0===b?void 0:b.id)===a.elementId&&(a.elementId+="-player",a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.elementId:a.config.attrs.id=a.elementId)}
l.setConfig=function(a){var b;this.Va=a;this.config=Gu(a);Du(this);this.Ea||(this.Ea=Hu(this,(null===(b=this.config.args)||void 0===b?void 0:b.jsapicallback)||"onYouTubePlayerReady"));this.config.args?this.config.args.jsapicallback=null:this.config.args={jsapicallback:null};var c;if(null===(c=this.config)||void 0===c?0:c.attrs)a=this.config.attrs,(c=a.width)&&this.j&&(this.j.style.width=Xd(Number(c)||c)),(a=a.height)&&this.j&&(this.j.style.height=Xd(Number(a)||a))};
function Fu(a){var b;a.config&&!0!==a.config.loaded&&(a.config.loaded=!0,!a.config.args||"0"!==a.config.args.autoplay&&0!==a.config.args.autoplay&&!1!==a.config.args.autoplay?a.api.loadVideoByPlayerVars(null!==(b=a.config.args)&&void 0!==b?b:null):a.api.cueVideoByPlayerVars(a.config.args))}
function Iu(a){var b=!0,c=Ju(a);c&&a.config&&(a=Ku(a),b=nt(c,"version")===a);return b&&!!A("yt.player.Application.create")}
function Eu(a){if(!a.h()&&!a.Y){var b=Iu(a);if(b&&"html5"===(Ju(a)?"html5":null))a.fa="html5",a.isReady()||Lu(a);else if(Mu(a),a.fa="html5",b&&a.l&&a.m)a.m.appendChild(a.l),Lu(a);else{a.config&&(a.config.loaded=!0);var c=!1;a.A=function(){c=!0;var d=Nu(a,"player_bootstrap_method")?A("yt.player.Application.createAlternate")||A("yt.player.Application.create"):A("yt.player.Application.create");var e=a.config?Gu(a.config):void 0;d&&d(a.m,e,a.webPlayerContextConfig);Lu(a)};
a.Y=!0;b?a.A():(rt(Ku(a),a.A),(b=Ou(a))&&uu(b),Pu(a)&&!c&&z("yt.player.Application.create",null,void 0))}}}
function Ju(a){var b=Ld(a.elementId);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.elementId));return b}
function Lu(a){var b;if(!a.h()){var c=Ju(a),d=!1;c&&c.getApiInterface&&c.getApiInterface()&&(d=!0);d?(a.Y=!1,!Nu(a,"html5_remove_not_servable_check_killswitch")&&(null===c||void 0===c?0:c.isNotServable)&&a.config&&(null===c||void 0===c?0:c.isNotServable(null===(b=a.config.args)||void 0===b?void 0:b.video_id))||Qu(a)):a.mb=xi(function(){Lu(a)},50)}}
function Qu(a){Bu(a);a.Ua=!0;var b=Ju(a);if(b){a.u=Ru(a,b,"addEventListener");a.Da=Ru(a,b,"removeEventListener");var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=a.api,e=0;e<c.length;e++){var f=c[e];d[f]||(d[f]=Ru(a,b,f))}}for(var g in a.i)a.i.hasOwnProperty(g)&&a.u&&a.u(g,a.i[g]);Fu(a);a.Ea&&a.Ea(a.api);a.S.ja("onReady",a.api)}
function Ru(a,b,c){var d=b[c];return function(){var e=Ha.apply(0,arguments);try{return a.lastError=null,d.apply(b,e)}catch(f){"sendAbandonmentPing"!==c&&(f.params=c,a.lastError=f,Sp(f))}}}
function Bu(a){a.Ua=!1;if(a.Da)for(var b in a.i)a.i.hasOwnProperty(b)&&a.Da(b,a.i[b]);for(var c in a.L)a.L.hasOwnProperty(c)&&yi(Number(c));a.L={};a.u=null;a.Da=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
function Cu(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){Sj("WATCH_LATER_VIDEO_ADDED",b)});
...
l.addEventListener=function(a,b){var c=this,d=Hu(this,b);d&&(0<=db(this.Mb,a)||this.i[a]||(b=Su(this,a),this.u&&this.u(a,b)),this.S.subscribe(a,d),"onReady"===a&&this.isReady()&&xi(function(){d(c.api)},0))};
l.removeEventListener=function(a,b){this.h()||(b=Hu(this,b))&&rg(this.S,a,b)};
function Hu(a,b){var c=b;if("string"===typeof b){if(a.Fa[b])return a.Fa[b];c=function(){var d=Ha.apply(0,arguments),e=A(b);if(e)try{e.apply(y,d)}catch(f){Rp(f)}};
a.Fa[b]=c}return c?c:null}
function Su(a,b){var c="ytPlayer"+b+a.M;a.i[b]=c;y[c]=function(d){var e=xi(function(){if(!a.h()){a.S.ja(b,null!==d&&void 0!==d?d:void 0);var f=a.L,g=String(e);g in f&&delete f[g]}},0);
qb(a.L,String(e))};
return c}
...
l.cancel=function(){this.A&&xt(Ku(this),this.A);yi(this.mb);this.Y=!1};
l.I=function(){Mu(this);if(this.l&&this.config&&this.l.destroy)try{this.l.destroy()}catch(b){Rp(b)}this.Fa=null;for(var a in this.i)this.i.hasOwnProperty(a)&&(y[this.i[a]]=null);this.Va=this.config=this.api=null;delete this.m;delete this.j;J.prototype.I.call(this)};
function Pu(a){var b,c;a=null===(c=null===(b=a.config)||void 0===b?void 0:b.args)||void 0===c?void 0:c.fflags;return!!a&&-1!==a.indexOf("player_destroy_old_version=true")}
...
function Nu(a,b){var c;if(a.webPlayerContextConfig)var d=a.webPlayerContextConfig.serializedExperimentFlags;else if(null===(c=a.config)||void 0===c?0:c.args)d=a.config.args.fflags;return"true"===lj(d||"","&")[b]}
function Gu(a){for(var b={},c=q(Object.keys(a)),d=c.next();!d.done;d=c.next()){d=d.value;var e=a[d];b[d]="object"===typeof e?vb(e):e}return b}
;var Tu={},Uu="player_uid_"+(1E9*Math.random()>>>0);function Vu(a,b,c){var d="player";c=void 0===c?!0:c;d="string"===typeof d?Ld(d):d;var e=Uu+"_"+Ra(d),f=Tu[e];if(f&&c)return Wu(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new Au(d,e,a,b);Tu[e]=f;Sj("player-added",f.api);re(f,function(){delete Tu[f.getId()]});
return f.api}
...
z("writeEmbed",function(){var a=B("PLAYER_CONFIG",void 0);if(!a){var b=B("PLAYER_VARS",void 0);b&&(a={args:b})}Fq(!0);"gvn"===a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=B("POST_MESSAGE_ORIGIN");window!==window.top&&c&&c!==document.URL&&(a.args.loaderUrl=c);M("embeds_js_api_set_1p_cookie")&&(c=qj(window.location.href),c.embedsTokenValue&&(a.args.embedsTokenValue=c.embedsTokenValue));cs();
if((c=B("WEB_PLAYER_CONTEXT_CONFIGS",void 0))&&"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in c){c=c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER;if(!c.serializedForcedExperimentIds){var d=qj(window.location.href);d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}Xu=Vu(a,c,!1)}else Xu=Vu(a);Xu.addEventListener("onVideoDataChange",$u);a=B("POST_MESSAGE_ID","player");B("ENABLE_JS_API")?Zu=new ku(Xu):B("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(Yu=new ru(window.parent,
a,b),Zu=new ou(Xu,Yu.connection));Bt();M("ytidb_create_logger_embed_killswitch")||tl();M("flush_gel_on_teardown")&&(a={},Vt||(Vt=new Ut),Vt.install((a.flush_logs={ka:function(){lk()}},a)));
M("networkless_logging_web_embedded")&&(M("embeds_web_enable_new_nwl")?To():ap());M("embeds_enable_ua_ch_polyfill")&&cu();M("ytidb_clear_embedded_player")&&bf.N(function(){if(!Js){Pq||(Pq=new Mq);var e=Pq;if(M("web_inject_fetch_manager")){var f={hc:Is,Kb:Hs};e.providers.set(f.hc,f)}f={pb:{feedbackEndpoint:$q(Ds),modifyChannelNotificationPreferenceEndpoint:$q(Es),playlistEditEndpoint:$q(Fs),subscribeEndpoint:$q(Bs),unsubscribeEndpoint:$q(Cs),webPlayerShareEntityServiceEndpoint:$q(Gs)}};var g=M("web_enable_client_location_service")?
...
var cv=li(function(){hs();var a=Nk.getInstance(),b=Qk(119),c=1<window.devicePixelRatio;if(document.body&&Af(document.body,"exp-invert-logo"))if(c&&!Af(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!Af(d,"inverted-hdpi")){var e=yf(d);zf(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&Af(document.body,"inverted-hdpi")&&Bf();if(b!=c){b="f"+(Math.floor(119/31)+1);d=Rk(b)||0;d=c?d|67108864:d&-67108865;0==d?delete Mk[b]:(c=d.toString(16),
Mk[b]=c.toString());c=!0;M("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.h;d=[];for(var f in Mk)d.push(f+"="+encodeURIComponent(String(Mk[f])));Jk(b,d.join("&"),63072E3,a.i,c)}Ts.h||(Ts.h=new Ts);a=Ts.h;f=16623;var g=void 0===g?{}:g;Object.values(pq).includes(f)||(Sp(new P("createClientScreen() called with a non-page VE",f)),f=83769);g.isHistoryNavigation||a.h.push({rootVe:f,key:g.key||""});a.o=[];a.C=[];g.sb?Ws(a,f,g):Xs(a,f,g)}),dv=li(function(){Xu&&Xu.sendAbandonmentPing&&Xu.sendAbandonmentPing();
B("PL_ATT")&&Jt.dispose();for(var a=bf,b=0,c=zt.length;b<c;b++)a.T(zt[b]);zt.length=0;wt("//web.archive.org/web/20220308204523/https://static.doubleclick.net/instream/ad_status.js");At=!1;Zh("DCLKSTAT",0);qe(Zu,Yu);Xu&&(Xu.removeEventListener("onVideoDataChange",$u),Xu.destroy())});
window.addEventListener?(window.addEventListener("load",cv),M("embeds_web_enable_replace_unload_w_pagehide")?window.addEventListener("pagehide",dv):window.addEventListener("unload",dv)):window.attachEvent&&(window.attachEvent("onload",cv),window.attachEvent("onunload",dv));Ya("yt.abuse.player.botguardInitialized",A("yt.abuse.player.botguardInitialized")||Kt);Ya("yt.abuse.player.invokeBotguard",A("yt.abuse.player.invokeBotguard")||Lt);
Ya("yt.abuse.dclkstatus.checkDclkStatus",A("yt.abuse.dclkstatus.checkDclkStatus")||Ct);Ya("yt.player.exports.navigate",A("yt.player.exports.navigate")||bv);Ya("yt.util.activity.init",A("yt.util.activity.init")||Ii);Ya("yt.util.activity.getTimeSinceActive",A("yt.util.activity.getTimeSinceActive")||fj);Ya("yt.util.activity.setTimestamp",A("yt.util.activity.setTimestamp")||Ji);}).call(this);


}
/*
     FILE ARCHIVED ON 20:45:23 Mar 08, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:18:39 Jul 21, 2023.
...
/*
playback timings (ms):
  captures_list: 435.254
  exclusion.robots: 0.07
  exclusion.robots.policy: 0.061
  RedisCDXSource: 15.598
  esindex: 0.008
  LoadShardBlock: 69.07 (3)
  PetaboxLoader3.datanode: 145.508 (4)
  load_resource: 207.576
  PetaboxLoader3.resolve: 117.127
*/