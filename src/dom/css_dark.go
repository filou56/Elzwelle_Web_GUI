...
func CssHandler_Dark_237(w http.ResponseWriter, r *http.Request) {
    ...
    fmt.Fprintf(w,"%s",`	
		...
		*/
		...
		[type="reset"].inverse, .button.inverse, [role="button"].inverse {
		  background: rgba(235, 236, 236, 0.9);
		  color: #0c0c0c;
		}
...
//		  height: 600px;
		...
		*/
		...
		.responsive-label .col-md-3 {text-align: left;}
...
SVG elements have the following CSS properties which you can set. 
Not all elements have all of these CSS properties. Therefore the CSS properties 
are split into multiple tables targeted at different elements.
